...
<?php
//SE VALIDA EL TIPO DE USUARIO Y SE ENVIA LA CABECERA CORRECTA PARA CADA USUARIO
if ($_SESSION['rol'] == '1') {
    header('location: index.php');
    exit;
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="contratante" value="" id="contratante" class="form-control input-sm" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Nombre Apaterno Amaterno" required>

                    <label>Prioridad:</label>
                    <select type="text" name="prioridad" value="" id="prioridad" class="form-control input-sm">
                        ...
                        if (t_solicitud.length == 0) {
                            ...
                            if (producto.length == 0) {
                                ...
                                if (comentarios.length >= 1 || /^\s+$/.test(comentarios)) {
                                    swal({
                                            title: "¡Recuerda!",
                                            text: "Los datos ingresados en la solicitud, deben ser los correctos",
                                            type: "info",
                            ...
                            if (polizap.length == 0) {
                                ...
                                swal({
                                    title: "¡Error!",
                                    text: "Ingrese la Monto correspondiente",
                                    type: "error",
                                    customClass: 'swal-wide',
                                    allowOutsideClick: false
                                });
                ...
                <script>
                    function guardarfolio() {
                        ...
                        $.ajax({
                            url: 'php/agregarfolio_consultor.php',
                            type: 'POST',
                            contentType: false,
                            data: formdata,
                            processData: false,
            ...
            $(document).ready(function() {
                ...
                $('#file').change(function() {
                    ...
                    if (status)
                        ...
                        $('#res_file').html(" tu archivo es demasido grande el limite es de 2 megas");
                });
                ...
                $('#solicitud').change(function() {
                    ...
                    if (status)
                        ...
                        $('#res_solicitud').html(" tu archivo es demasido grande el limite es de 10 megas");
                });
                ...
                $('#identificacion').change(function() {
                    ...
                    if (status)
                        ...
                        $('#res_identificacion').html(" tu archivo es demasido grande el limite es de 10 megas");
                });
                ...
                $('#comprobante').change(function() {
                    ...
                    if (status)
                        ...
                        $('#res_comprobante').html(" tu archivo es demasido grande el limite es de 10 megas");
                });

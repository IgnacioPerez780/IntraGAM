...
foreach ($_POST['valido'] as $idvalido) {
    ...
    $id = "select agente from folios_a where id='$idf'";
    ...
    $consulta = "insert into validar_archivos_a set id_archivo='$idvalido'";
    //echo $consulta.'<br />';
...
echo '<script type="text/javascript">
	jQuery(function(){   
		...
		function(){
			window.location.href = "seguimiento_a_c.php?id=' . $idf . '";
		})
	});
  </script>';
?>
...
<!-- Cabera que mostrara para el agente -->
<?php
...
<body>
        ...
        <div class="row">
            <div class="table-responsive">
                ...
                <table class="table table-striped table-bordered text-center" id="tablaCamp">
                    ...
                    <!-- Query para mostrar y descargar el material de seccion correspondiente -->
                    <?php
    ...
    <div class="container">
        <div class="row">
            <table class="table table-striped table-bordered text-center" id="tablaInfoA">
                <tr>

...
//var_dump($ids);
//DESCUENTO DE NOTIFICACIONES
$cont = "UPDATE notificaciones1_a set contador='0' where folio='$ids'";
...
<!-- termina codigo alertas
 -->
    ...
    <script src="js/main_autos_agente.js"></script>
   ...
   $sql = "SELECT * FROM folios_a where id='$ids'";
                    ...
                    while ($ver = mysqli_fetch_row($result)) {
                        $datos = $ver[0] . "||" .
                            ...
                            if ($ver[13] == 'TERMINADO' || $ver[13] == 'TERMINADO CON POLIZA') {
                                $terminado = 1 ;
                                if ($respondido != $ids ) {
                                ...
                                while ($row = mysqli_fetch_row($resultado)) { ?>
                                    <tr>
                                        ...
                                        <td colspan="3" align="center"><?php echo $row[1]; ?></td>
                                         <td colspan="1" align="center" <?php  if ($respondido != $ids && $terminado == '1' ) { ?> onclick="return abrirmodal();" <?php } ?> > <a href="../sistemas/archivos_a/<?php echo $row[1]; ?>" target=" _blank">
...
<!--                                     CODIGO PARA EL BOTON DE DESCARGA     
 -->                                      <?php 
                                        ...
                                        $cadena_buscada = "emision_de_poliza"; 
...
<!--                          TERMINA CODIGO PARA EL BOTON           
 -->                                    </td>
                            ...
                            <form enctype="multipart/form-data" id="filesforma1">
                                <tr>
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    "> <!-- SE CIERRA LA ETIQUETA A CON EL TOOLTIP -->
                        ...
                        <tr class="observaciones">
                            ...
                            <td colspan="8" align="center" class="observaciones">
                                <button type="button" class="btn btn-warning glyphicon glyphicon-ok" id="guardar6"></button>
                            </td>
                        </tr>
         ...
         <a  style="color: black"
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    <tr class="observaciones">
                        <td colspan="8" align="center"><b>Términos y Condiciones</b></td>
                    </tr>
                    <tr class="observaciones">
                        ...
                        <td colspan="5" align="center">
                            <form action="validar-checkbox_a.php" method="post">
                                <div class="checkbox" id="checkbox_a" align="center">
                                    <input type="checkbox" style="display: none" id="checkbox1_a" name="condiciones[<?php echo $ids; ?>]" value="<?php echo "$ids"; ?>" onclick="validarcheck_a()">
                                    <label style="font-weight:bold;color:#FFFFFF;" for="checkbox1_a">Acepto términos y condiciones bajo los que fue resuelta mi solicitud.</label required>
                                    <br><button type="submit" class="btn btn-warning glyphicon glyphicon-ok" id="aceptar_a" style="display: none"></button></br>
                                </div>
                            </form>
...
<!--                          TERMINA CODIGO PARA EL BOTON           
 -->                                    </td>
                    ...
                    <form enctype="multipart/form-data" id="filesforma1">
                        <tr>
                            <td colspan="9" align="center" bgcolor="#428BCA">
                                <b>
                                    <p style="color: #FFFFFF">AGREGAR MAS ARCHIVOS</p>
                                </b>
                            </td>
           ...
           <a  style="color: black"
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                ...
                <tr class="observaciones">
                    ...
                    <td colspan="8" align="center" class="observaciones">
                        <button type="button" class="btn btn-warning glyphicon glyphicon-ok" id="guardar6" disabled></button>
                    </td>
                </tr>
 ...
 $(document).ready(function() {
    ...
    $(document).ready(function() {
        $('#guardar6').click(function() {
            ...
            if (estado == 'ENVIADO' || estado == 'INCOMPLETO' || estado == 'PROCESO' || estado == 'TERMINADO') {
...
<script type="text/javascript">
    function conformidad_a() {
        ...
        document.getElementById("checkbox1_a").checked = true;
        document.getElementById("checkbox1_a").disabled = true;

    }

    function validarcheck_a() {
        var opcion = document.getElementById('checkbox1_a');
        if (opcion.checked == true) { //botón seleccionado
            document.getElementById("aceptar_a").style.display = 'block';

        } else { //botón no seleccionado
            document.getElementById("aceptar_a").style.display = 'none';

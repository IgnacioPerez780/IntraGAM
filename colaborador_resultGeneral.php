...
if ($periodoGeneral_v == "1_v") {
    ...
    $consultaAgente = "SELECT COUNT(*) FROM folios WHERE MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
    ...
    Highcharts.chart('container70', {
        ...
        subtitle: {
            text: 'Total:  <?php
                            ...
                            /* ESTE CODIGO ES PARA MOSTRAR CONSULTA PERSONALIZADA */
                            if ($periodoGeneral_v == "7_v") {
                                $consultSem = "SELECT COUNT(*) FROM folios WHERE fecha BETWEEN '$periodoSemG1_v' AND '$periodoSemG2_v'";
        ...
        series: [
            ...
            if ($periodoGeneral_v == "1_v") {
                ...
                $consultaProspectos = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'ALTA DE POLIZA' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                ...
                $nuevafecha2 = strtotime('+1 day', strtotime($fecha2));
                $nuevafecha2 = date('Y-m-d', $nuevafecha2);
                $consultaProspectos = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'ALTA DE POLIZA' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultProspectos = mysqli_query($conexion, $consultaProspectos);
                $prospectos = mysqli_fetch_array($resultProspectos);
                $datosProspectos = $prospectos[0];
            }
            ...
            if ($periodoGeneral_v == "1_v") {
                ...
                $date = new DateTime($year . '-' . $month . '-' . $day);
                $fecha = $date->format('Y-m-d');
                $consultaCitas = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'MOVIMIENTOS' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                ...
                $nuevafecha2 = strtotime('+1 day', strtotime($fecha2));
                $nuevafecha2 = date('Y-m-d', $nuevafecha2);
                $consultaCitas = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'MOVIMIENTOS' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            }
            ...
            if ($periodoGeneral_v == "1_v") {
                ...
                $date = new DateTime($year . '-' . $month . '-' . $day);
                $fecha = $date->format('Y-m-d');
                $consultaEntrevista = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'PAGOS' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                ...
                $nuevafecha2 = strtotime('+1 day', strtotime($fecha2));
                $nuevafecha2 = date('Y-m-d', $nuevafecha2);
                $consultaEntrevista = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'PAGOS' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultEntrevista = mysqli_query($conexion, $consultaEntrevista);
                $entrevista = mysqli_fetch_array($resultEntrevista);
                $datosEntrevista = $entrevista[0];
            }

            // GRAFICA DEL LADO DERECHO / SEMANAL
            if ($periodoGeneral_v == "7_v") {
                $consultaProspectos = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'ALTA DE POLIZA' AND fecha BETWEEN '$periodoSemG1_v' AND '$periodoSemG2_v'";
                $resultProspectos = mysqli_query($conexion, $consultaProspectos);
                $prospectos = mysqli_fetch_array($resultProspectos);
                $datosProspectos = $prospectos[0];
            }
            ...
            if ($periodoGeneral_v == "7_v") {
                $consultaCitas = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'MOVIMIENTOS' AND fecha BETWEEN '$periodoSemG1_v' AND '$periodoSemG2_v'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            }
            ...
            if ($periodoGeneral_v == "7_v") {
                $consultaEntrevista = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'PAGOS' AND fecha BETWEEN '$periodoSemG1_v' AND '$periodoSemG2_v'";
                $resultEntrevista = mysqli_query($conexion, $consultaEntrevista);
                $entrevista = mysqli_fetch_array($resultEntrevista);
                $datosEntrevista = $entrevista[0];
            }

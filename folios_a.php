...
if (isset($_SESSION['logged_in'])) {
    ...
    if (isset($_SESSION["timeout"])) {
        ...
        if ($sessionTTL > $inactive) {
            ...
            if ($nomusuario == "Christian C" || $nomusuario == "Veronica S" || $nomusuario == "Giovanni M" || $nomusuario == "Karla B" || $nomusuario == "Diana C" || $nomusuario == "Carolina H" || $nomusuario == "Dante V" || $nomusuario == "Manuel R") {
...
<head>
    ...
    <!-- JS -->
    <script src="js/registro_folios_a.js"></script>

...
<div class="row" style="width: 1240px;">
	<div class="col-sm-12">
		<h2 class="h2Gdd">Trámites de Gastos Médicos</h2>
		<table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadGdd">
			<caption></caption>
			<thead>
				<tr>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>FOLIO GAM</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>TIPO DE SOLICITUD</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>NOMBRE DEL AGENTE</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>NOMBRE DEL CONTRATANTE</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>N° PÓLIZA</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>PRIORIDAD</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>FECHA SOLICITUD</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>FOLIO GNP (OT)</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>FECHA INICIO</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>FECHA PROMESA</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>DÍAS DE RETARDO</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>ESTATUS TRAMITE</p>
					</td>
					<td class="tdGmm">
						<p style="color:#FFFFFF" ;><small>VER MÁS</p>
					</td>
				</tr>
			</thead>
			<tbody>
				<!-- Query muestra los folios de gmm pero correspondientes a cada uno de los gdd -->
				<?php
				$sql = "SELECT * FROM folios_g INNER JOIN datos_agente ON folios_g.agente=datos_agente.id AND datos_agente.GDD='$id' ORDER BY folios_g.id DESC";
				...
				?>
					<tr>
						...
						<!-- FOLIO -->
						<td align="center" width="100px"><small><?php echo $ver[6]; ?></small></td>
						...
						<!-- ESTATUS DEL TRAMITE  -->
						<td align="center" width="90px"><small><?php echo $ver[14]; ?></small></td>

						<!-- VER SEGUIMIENTO  -->
						<td align="center" width="40px">
							<form class="" action="seguimiento_g_colab_g.php?id=<?php echo $ver[0]; ?>" method="post">
...
<footer>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#tablaDinamicaLoadGdd').DataTable({
				"order": [
					[0, 'desc']
				],
				stateSave: true,

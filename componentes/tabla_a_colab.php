...
<div class="row">
    <div class="col-sm-12" style="width: 1240px;">
        ...
        <table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadAuto">
            ...
            <tbody>
                <!--Query muestra los folios del ramo de autos en forma descendete y como limite solo los ultimos 100-->
                <?php
                ...
                ?>
                    <tr>
                        ...
                        <!-- TIPO DE SOLICITUD  -->
                        <td width="80px"><small><?php echo "$ver[3]"; ?></small></td>
                        ...
                        <td width="230px"><small><?php echo $ver[6]; ?></small></td>

                        <!-- NUMERO DE POLIZA  -->
                        <td width="80px"><small><?php echo $ver[7]; ?></small></td>

                        <!-- PRIORIDAD -->
                        <td width="50px"><small><?php echo $ver[9]; ?></small></td>
                        ...
                        <!-- FOLIO -->
                        <td width="120px"><small><?php echo $ver[8]; ?></small></td>
                        ...
                        <!-- ESTATUS DEL TRAMITE  -->
                        <td width="70px"><small><?php echo $ver[13]; ?></small></td>

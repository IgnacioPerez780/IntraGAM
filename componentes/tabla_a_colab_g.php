...
<div class="row" style="width: 1240px;">
    <div class="col-sm-12">
        <h2 class="h2Consultor">Trámites de Autos</h2>
        <table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadAuto">
            ...
            <tbody>
                <?php
                // Query mostrara solo los folios correspondientes de cada GDD
                $sql = "SELECT * FROM folios_a INNER JOIN datos_agente ON folios_a.agente=datos_agente.id AND datos_agente.GDD='$id' ORDER BY folios_a.id DESC";
                ...
                ?>
                    <tr>
                                ...
                                <small>
                                        ...
                                        while ($verProductoA = mysqli_fetch_row($resultProductoA)) {
                                            ...
                                            while ($i < $dias) {
                                                ...
                                                foreach ($feriados as $key => $feriado) {
                                                    //Se verifica si la fecha final actual es feriado o no
                                                ...
                                                //Verifico que no sea sabado, domingo o feriado
                                    ...
                                    if ($ver[3] == 'MOVIMIENTOS') {
                                        ...
                                        while ($verProductoA = mysqli_fetch_row($resultProductoA)) {
                                            ...
                                            //Validamos fecha promera y fecha actual para accionar el semaforo
                                            if ($ver[13] == 'PROCESO') {
                        ...
                        <td align="center" width="75px">
                            <small>
                                ...
                                if ($ver[13] == 'PROCESO') {
                                    ...
                                    //Se establece intervalo de 1 dia
                                    ...
                                    //Se acciona para validar si hay dias de retardo o no
                                ...
                                if ($ver[13] == "TERMINADO") {
                                    ...
                                    while ($verpr = mysqli_fetch_row($resultpr)) {
                                        ...
                                        //Comparamos la fecha inicial con la final para accionar los dias de retardo
                                        if ($startDate > $endDate) {
                        ...
                        <td align="center" width="50px">
                            <form class="" action="seguimiento_a_colab_g.php?id=<?php echo $ver[0]; ?>" method="post">

...
<div class="row">
	<div class="col-sm-12">
		<h2>Mis Trámites de Gastos Médicos</h2>
		...
		<table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoad">
			...
			<tbody>
				<!-- Query muestra los folios de gmm dependiendo el id del agente -->
				<?php
				$sql = "SELECT * FROM folios_g WHERE agente=$id ORDER BY id DESC";
				...
				?>
					<tr>
						...
						<td align="center" width="250px"><small><?php echo $ver[10]; ?></small></td>

						<!-- NUMERO DE POLIZA  -->
						<td align="center" width="80px"><small><?php echo $ver[5]; ?></small></td>
						...
						<td align="center" width="100px">
							<small>
								<?php
								$fechagmmAgente = $ver[1];
								$fechagmmAgente1 = new DateTime($fechagmmAgente);
								echo $fechagmmAgente1->format("d-m-Y");
								?>
							</small>
						</td>
						...
						<td align="center" width="50px">
							<form class="" action="seguimiento_g_a.php?id=<?php echo $ver[0]; ?>" method="post">

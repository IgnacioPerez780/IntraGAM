...
<div class="row" style="width: 1270px;">
	<div class="col-sm-12">
		<h2 class="h2Consultor">Mis Trámites</h2>
		<table data-order='[[0, "desc"]]' class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadGmm">
			...
			<tbody>
				<!-- Query muestra los ultimos 100 folios de gmm -->
				<?php
				$sql = "SELECT * FROM folios_g WHERE estado != 'TERMINADO' AND estado != 'TERMINADO CON POLIZA' AND estado != 'CANCELADO' AND estado != 'RECHAZO DE SUSCRIPCION' OR fecha >= date_add(NOW(), INTERVAL -91 DAY)";

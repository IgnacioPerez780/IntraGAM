...
<div class="row">
    <div class="col-sm-12">
        <h2>Mis últimos 100 Trámites</h2>
        <table data-order='[[0, "desc"]]' class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoad">
            ...
            <tbody>
                ...
                <?php
                $sql = "SELECT * FROM folios_s ORDER BY id DESC LIMIT 100";
                ...
                ?>
                    <tr>
                        <!-- FOLIO GAM -->
                        <td align="center" width="50px"><span style="font-weight:bold;"><small><?php echo $ver[0]; ?></small></span></td>
                        <!-- RAMO -->
                        ...
                        <td align="center" width="80px">
                            <small>
                                ...
                                // echo $fechaS->format("d-m-Y H:i:s"); con hora
                        ...
                        <td align="center" width="50px">
                            <form class="" action="seguimiento_s_colab.php?id=<?php echo $ver[0]; ?>" method="post">

    ...
    <div class="col-sm-12">
        ...
        <table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoad">
            ...
            <tbody>
                ...
                <?php
                $sql = "SELECT * FROM folios_s INNER JOIN datos_agente ON folios_s.id_agente=datos_agente.id AND datos_agente.GDD='$id' ORDER BY folios_s.id DESC";
                ...
                ?>
                    <tr>
                        <td align="center" width="80px"><small><span style="font-weight:bold;"><?php echo $ver[0]; ?></small></span></td>
                        ...
                        <td align="center" width="50px">
                            <form class="" action="seguimiento_s_colab_g.php?id=<?php echo $ver[0]; ?>" method="post">

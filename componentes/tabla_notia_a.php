    ...
    <h2>Mis notificaciones</h2>
        <table data-order='[[1, "desc"]]' class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoad"><!--Data-order ordenamiento de descendente a ascendente-->
          ...
          <td align="center" width="20px"><b>DETALLES</b></td>
            ...
            <tbody>
        <?php
          $sql = "SELECT * FROM notificaciones1_a WHERE contador = '1' and id_agente='$id' ORDER BY id DESC";
            ...
            <tr>
                <td align="center" width="1000px"><small>
                  ...
                  if($ver[5]=="COMENTARIO"){?>
                    ...
                    <b><?php echo $ver[2]; ?></b> agregó un nuevo <b><?php echo $ver[5]; ?></b> al folio <b>FA<?php echo $ver[1]; ?></b>, con estatus <b><?php echo $ver[3]; ?></b> el día <b><?php echo $ver[4]; ?></b>

                    <?php

                  }else if($ver[5]=="ARCHIVO"){?>
                    
                    <b><?php echo $ver[2]; ?></b> adjuntó un nuevo <b><?php echo $ver[5]; ?></b> al folio <b>FA<?php echo $ver[1]; ?></b>, con estatus <b><?php echo $ver[3]; ?></b> el día <b><?php echo $ver[4]; ?></b>
                    ...
                    <b><?php echo $ver[2]; ?></b> te generó un nuevo <b><?php echo $ver[5]; ?></b> el día <b><?php echo $ver[4]; ?></b> y le fue asignado el folio <b>FA<?php echo $ver[1]; ?></b> 

                    <?php

                  }else if($ver[5]=="VALIDADO"){?>

                    <b><?php echo $ver[2]; ?></b> <b>VALIDÓ</b> un archivo adjunto al folio <b>FA<?php echo $ver[1]; ?></b> el día <b><?php echo $ver[4]; ?></b>
                ...
                <td align="center" width="20px">
                    <form class="" action="seguimiento_a_a.php?id=<?php  echo $ver[1]; ?>" method="post">

        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        ?>
                            ...
                            <!-- Detalles -->
                            <td align="center">
                                <form class="" action="seguimiento_a_colab.php?id=<?php echo $datoTramite; ?>" method="post">
                ...
                <tr>
                    ...
                    ?>
                        ...
                        <!-- Detalles -->
                        <td align="center">
                            <form class="" action="seguimiento_a_colab.php?id=<?php echo $datoComent; ?>" method="post">
            ...
            <tr>
                ...
                ?>
                    ...
                    <!-- Detalles estoy aqui-->
                    <td align="center">
                        <form class="" action="seguimiento_a_colab.php?id=<?php echo $datoAr; ?>" method="post">

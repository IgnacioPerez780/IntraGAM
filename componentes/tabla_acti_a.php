...
<div class="row" style="width: 1240px;">
    <div class="col-sm-12">
        ...
        <table data-order='[[0, "desc"]]' class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadAuto">
            ...
            <tbody>
                <!-- Query muestra los folios del ramo de autos con estado cancelado -->
                <?php
                $sql = "SELECT * FROM folios_a WHERE estado = 'CANCELADO' ORDER BY id";
                ...
                ?>
                    <tr>
                        ...
                        <td align="center" width="50px">
                            <button class="btn btn-link glyphicon glyphicon-retweet " data-toggle="modal" data-target="#modalUpload_a" onclick="reactivar_a('<?php echo $datos ?>')"></button>
                        </td>
                    </tr>
                <?php
                }

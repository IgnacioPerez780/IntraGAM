...
?>
<div class="row" style="width: 1253px;">
    <div class="col-sm-12">
        <h2 class="h2Gdd">Trámites de Vida</h2>
        ...
        <table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadGdd">
            ...
            <tbody>
                <!-- Query muestra los folios del ramo en vida pero correspondientes al grupo de cada GDD -->
                <?php
                $sql = "SELECT * FROM folios INNER JOIN datos_agente ON folios.id_agente=datos_agente.id AND datos_agente.GDD='$id' ORDER BY folios.id DESC";
                ...
                ?>
                    <tr>
                        ...
                        <td align="center" width="70px"><small>$<?php echo $ver[7]; ?></small></td>
                        ...
                        <td align="center" width="50px">
                            <form class="" action="seguimiento_colab_g.php?id=<?php echo $ver[0]; ?>" method="post">

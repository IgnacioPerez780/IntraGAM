...
<div class="row">
    <div class="col-sm-12">
        <h2>Mis Trámites de Autos</h2>
        <table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadAutos">
            <caption>
            ...
            <tbody>
                <!--Query mostrara los folios en orden descendente el ramo de autos-->
                <?php
                $sql = "SELECT * FROM folios_a WHERE agente=$id ORDER BY id DESC";
                ...
                ?>
                    <tr>
                        ...
                        <!-- TIPO DE SOLICITUD  -->
                        <td align="center" width="110px"><small><?php echo "$ver[3]"; ?></small></td>
                        ...
                        <!-- PRIORIDAD -->
                        <td align="center" width="80px"><small><?php echo $ver[9]; ?></small></td>
                        ...
                        <!-- ESTATUS DEL TRAMITE  -->
                        <td align="center" width="90px"><small><?php echo $ver[13]; ?></small></td>

                        <!-- VER SEGUIMIENTO  -->
                        <td align="center" width="50px">
                            <form class="" action="seguimiento_a_a.php?id=<?php echo $ver[0]; ?>" method="post">
...
<footer>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#tablaDinamicaLoadAutos').DataTable({
                "order": [
                    [0, 'desc']
                ],
                stateSave: true,

    ...
    <table id="tablaDinamicaLoad" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        ?>
                            ...
                            <!-- Detalles -->
                            <td align="center">
                                <form class="" action="seguimientocon.php?id=<?php echo $datoTramite; ?>" method="post">
                ...
                <tr>
                    ...
                    ?>
                        ...
                        <!-- Detalles -->
                        <td align="center">
                            <form class="" action="seguimientocon.php?id=<?php echo $datoComent; ?>" method="post">
            ...
            <tr>
                ...
                ?>
                    ...
                    <!-- Detalles -->
                    <td align="center">
                        <form class="" action="seguimientocon.php?id=<?php echo $datoAr; ?>" method="post">
        ...
        <tr>
            ...
            ?>
                ...
                <!-- Detalles -->
                <td align="center">
                    <form class="" action="seguimientocon.php?id=<?php echo $datoReact; ?>" method="post">

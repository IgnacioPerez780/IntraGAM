...
<div class="row">
    <div class="col-sm-12">
        <h2>Mis Trámites Totales</h2>
        <!--Data-order ordenamiento de descendente a ascendente-->
        <table data-order='[[1, "desc"]]' class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoad">
            <caption></caption>
            <thead>
                <tr>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>FOLIO GAM
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>RAMO
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>TIPO SOLICITUD
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>NOMBRE DEL AGENTE
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>NOMBRE DEL CONTRATANTE
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>N° PÓLIZA
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>FECHA SOLICITUD
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>FOLIO GNP (OT)
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>FECHA INICIO
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>FECHA PROMESA
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>DÍAS DE RETARDO
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>ESTATUS TRÁMITE
                    </td>
                    <td align="center" style="vertical-align:middle;" bgcolor="#428BCA">
                        <p style="color:#FFFFFF" ;><span style="font-size:10pt;"><small>VER MÁS
                    </td>

                </tr>
            </thead>
            <tbody>
                <!-- Query muestra todos los folios del ramo vida -->
                <?php
                $sql = "SELECT * FROM folios WHERE id > 20000 ORDER BY id DESC";
                ...
                ?>
                    <tr>
                        <!--FOLIO-->
                        <td align="center" width="30px" style="vertical-align:middle;"><span style="font-size:10pt;"><small><?php echo $ver[0]; ?></small></td>

                        <!--LINEA DE NEGOCIO-->
                        <td align="center" width="30px" style="vertical-align:middle;"><span style="font-size:10pt;"><small><?php echo $ver[2]; ?></small></td>

                        <!--TIPO DE SOLICITUD-->
                        <td align="center" width="80px" style="vertical-align:middle;"><span style="font-size:10pt;"><small><?php echo $ver[3]; ?></small></td>

                        <!--AGENTE-->
                        <td align="center" width="150px" style="vertical-align:middle;"><span style="font-size:10pt;">
                                <small>
                                    <?php
                        ...
                        <!--CONTRATANTE-->
                        <td align="center" width="150px" style="vertical-align:middle;"><span style="font-size:10pt;"><small><?php echo $ver[11]; ?></small></td>

                        <!--CAMBIO ANEXADO PARA VISUALIZAR LA POLIZA QUE SE INGRESO EN EL CAMPO CORRESPONDIENTE DE CADA SOLICITUD-->
                        <td align="center" width="90px" style="vertical-align:middle;"><span style="font-size:10pt;">
                        ...
                        <!--FECHA SOLICITUD-->
                        <td align="center" width="50px" style="vertical-align:middle;"><span style="font-size:10pt;">
                        ...
                        <!--FOLIO GNP-->
                        <td align="center" width="80px" style="vertical-align:middle;"><span style="font-size:10pt;"><small><?php echo $ver[16]; ?></small></td>


                        <!--FECHA INICIO-->
                        <td align="center" width="80px" style="vertical-align:middle;"><span style="font-size:10pt;">
                        ...
                        <!--FECHA PROMESA-->
                        <td align="center" width="90px" style="vertical-align:middle;"><span style="font-size:10pt;"><b>
                                    ...
                                    if ($ver[3] == 'PAGOS') {
                                        ...
                                        <small>
                                            ...
                                            while ($verfecha = mysqli_fetch_row($resultado)) {
                                                ...
                                                $fechap = strtotime(date("d-m-Y", strtotime($datosfecha))); //reseteo de la fecha cambio de estado
                        ...
                        <!--RETARDO DE DIAS -->
                        <td align="center" width="40px" style="vertical-align:middle;"><span style="font-size:10pt;">
                        ...
                        <!--ESTADO-->
                        <td align="left" width="130px" style="vertical-align:middle;"><span style="font-size:10pt;">

                                <?php
                                if ($ver[14] == 'CANCELADO') { ?>
                                    <img src="img/Cancelado.png" width="30" height="30" />
                                    <small><b>Cancelado</b></small>
                                <?php
                                }
                                if ($ver[14] == 'ACTIVADO FLT') { ?>
                                    <img src="img/Activado FLT.png" width="30" height="30" />
                                    <small><b>ACT FLT</b></small>
                                <?php
                                }
                                if ($ver[14] == 'ACTIVADO GNP') { ?>
                                    <img src="img/Activado GNP.png" width="30" height="30" />
                                    <small><b>ACT GNP</b></small>
                                <?php
                                }
                                if ($ver[14] == 'ACTIVADO MED') { ?>
                                    <img src="img/med.png" width="30" height="30" />
                                    <small><b>ACT MED</b></small>
                                <?php
                                }
                                if ($ver[14] == 'PROCESO') { ?>
                                    <img src="img/Procesos.png" width="30" height="30" />
                                    <small><b>Proceso</b></small>
                                <?php
                                }
                                if ($ver[14] == 'REPROCESO') { ?>
                                    <img src="img/Reproceso.png" width="30" height="30" />
                                    <small><b>Reproceso</b></small>
                                <?php
                                }
                                if ($ver[14] == 'ENVIADO') { ?>
                                    <img src="img/enviado.png" width="30" height="30" />
                                    <small><b>Enviado</b></small>
                                <?php
                                }
                                if ($ver[14] == 'TERMINADO') { ?>
                                    <img src="img/Terminado.png" width="30" height="30" />
                                    <small><b>Terminado</b></small>
                                <?php
                                }
                                if ($ver[14] == 'TERMINADO CON POLIZA') { ?>
                                    <img src="img/tp.png" width="30" height="30" />
                                    <small><b>Terminado / P</b></small>
                                <?php
                                }
                                ?>
                        </td>
                        <td align="center" width="50px" style="vertical-align:middle;">
                            <form class="" action="seguimientocon.php?id=<?php echo $ver[0]; ?>" method="post">
                                <!--DETALLES-->

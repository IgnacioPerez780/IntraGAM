...
//Proporciona el nombre del servidor especificado en la configuracion del host
$base_url = "HTTPS://" . $_SERVER['HTTP_HOST'] . "/sistemas/";

?>
<div class="row">
    <div class="col-sm-12">
        <h2>Mis Trámites de Vida</h2>
        ...
        <table class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoad">
            ...
            <tbody>
                <!--Consulta para traer los folios de vida del agente que se loguee apartir del folio 20000 de forma descendente-->
                <?php
                $sql = "SELECT * FROM folios WHERE id_agente=$id AND id > 20000 ORDER BY fecha DESC";
                $result = mysqli_query($conexion, $sql);

                //Devuelve un array de cadenas que se corresponde con la fila obtenida
                ...
                ?>
                    ...
                    <tr>
                        <!--Folio GAM-->
                        <td align="center" width="50px" style="font-weight:bold;"><small><?php echo $ver[0]; ?></small></td>
                        <!--Tipo Solicitud-->
                        <td align="center" width="90px"><small><?php echo $ver[3]; ?></small></td>
                        <!--Nombre del contratante-->
                        <td align="center" width="223px"><small><?php echo $ver[11]; ?></small></td>
                        <!--VISUALIZA LA POLIZA QUE SE INGRESO EN EL CAMPO CORRESPONDIENTE DE CADA SOLICITUD-->
                            ...
                            <small>
                                ...
                                if ($ver[14] == 'ACTIVADO FLT' or $ver[14] == 'ACTIVADO MED' or $ver[14] == 'ACTIVADO GNP') { //IF 1
                                    ...
                                    while ($verpr = mysqli_fetch_row($resultpr)) { //WHILE 1
                                        ...
                                        //Si la diferencia de días en activados es mayor a 20 actualiza el folio a Cancelado
                                        if ($res > 20) {
                        ...
                        <td style="text-align:left;" width="120px">
                            ...
                            if ($ver[14] == 'ACTIVADO FLT') { ?>
                                <img src="img/Act_Flt.png" width="30" height="30" />
                                <small><b>ACT. FLT</b></small>
                            <?php
                            }
                            if ($ver[14] == 'ACTIVADO GNP') { ?>
                                <img src="img/Act_GNP.png" width="30" height="30" />
                                <small><b>ACT. GNP</b></small>
                            <?php
                            }
                            if ($ver[14] == 'ACTIVADO MED') { ?>
                                <img src="img/Act_Med.png" width="30" height="30" />
                                <small><b>ACT. MED</b></small>
                            <?php
                            }
                            if ($ver[14] == 'PROCESO') { ?>
                                <img src="img/Proceso.png" width="30" height="30" />
                            ...
                            if ($ver[14] == 'TERMINADO CON POLIZA') { ?>
                                <img src="img/Terminado_p.png" width="30" height="30" />
                        ...
                        <!-- DETALLES -->
                        <td align="center" width="50px">
                            <form class="" action="seguimiento.php?id=<?php echo $ver[0]; ?>" method="post">
                                <button class="btn btn-link glyphicon glyphicon-search" value="<?php echo $ver[0]; ?>" id="id" name="id" style="outline: none;"></button>
                            </form>

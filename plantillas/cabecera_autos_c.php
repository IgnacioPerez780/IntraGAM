        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    $sqlC = "SELECT COUNT(DISTINCT folio) FROM notificaciones_a WHERE contador = '1' AND tipo = 'COMENTARIO' AND folio > '0'";
                    $resultC = mysqli_query($conexion, $sqlC);
                    while ($verC = mysqli_fetch_row($resultC)) {
                        $datosC = $verC[0];
                    }

                    $sqlA = "SELECT COUNT(DISTINCT folio) FROM notificaciones_a WHERE contador = '1' AND tipo = 'ARCHIVO' AND folio > '0'";
                    $resultA = mysqli_query($conexion, $sqlA);
                    while ($verA = mysqli_fetch_row($resultA)) {
                        $datosA = $verA[0];
                    }

                    $sqlT = "SELECT COUNT(DISTINCT folio) FROM notificaciones_a WHERE contador = '1' AND tipo = 'TRAMITE' AND folio > '0'";
                    $resultT = mysqli_query($conexion, $sqlT);
                    while ($verT = mysqli_fetch_row($resultT)) {
                        $datosT = $verT[0];
                    }

                    $sqlR = "SELECT COUNT(DISTINCT folio) FROM notificaciones_a WHERE contador = '1' AND tipo = 'REACTIVACION' AND folio > '0'";
                    ...
                    <li><a href="notificaciones_a.php" title="Notificaciones"><span class="glyphicon glyphicon-bell"></span>
                            <?php
                            echo $totalN;
                    ...
                    <!-- cambio aqui -->
                    <li><a href="reportesa.php"><span class="glyphicon glyphicon-download-alt" title="Reportes"></span></a></li>
                    <li><a href="folios_a.php"><span class="glyphicon glyphicon-search" title="Búsqueda de Folios"></span></a></li>
                    <li><a href="activar_a.php" title="Activar Folios"><span class="glyphicon glyphicon-retweet"></span></a></li>
                    <li><a href="menu_consultor.php"><span class="glyphicon glyphicon-menu-hamburger"></span> Menú</a></li>
                    <li><a href="autoscon.php"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></li>

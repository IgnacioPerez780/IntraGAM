        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    ?>
                    <li><a href="notificaciones_a_colab.php"><span class="glyphicon glyphicon-bell"></span>
                            <?php
                            echo $totalN;
                    ...
                    <li><a href="folios_colabA.php"><span class="glyphicon glyphicon-search" title="Búsqueda de Folios"></span></a></li>
                    <li><a href="menu_colaborador.php"><span class="glyphicon glyphicon-menu-hamburger"></span> Menú</a></li>
                    <li><a href="autos_colab.php"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></li>

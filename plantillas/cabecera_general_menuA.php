        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <!-- Dependiendo del rol que acceda mostrara un encabezado diferente -->
                    <?php if ($x == "1") {
                    ?>
                    ...
                    <?php } else { ?>
                        <li><a title="Ayuda" href="tutorial.php"><span class="glyphicon glyphicon-question-sign" style="font-size:17px;"></span> Ayuda</a></li>
                        <li><a href="actualizar_pass.php"><span class="glyphicon glyphicon-lock"></span> Cambiar Contraseña</a></li>
                        <li><a href="salir.php"><span class="glyphicon glyphicon-log-in"></span> Salir</a></li>
                    <?php } ?>
                </ul>
            </div>

        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    $sqlR = "SELECT COUNT(DISTINCT folio) FROM notificaciones_s WHERE contador = '1' AND tipo = 'REACTIVACION' AND folio > '0'";
                    ...
                    ?>
                    <li><a href="notificaciones_s.php" title="Notificaciones"><span class="glyphicon glyphicon-bell"></span>
                            <?php
                            echo $totalN;
                    ...
                    <li><a href="reportess.php" title="Reportes"><span class="glyphicon glyphicon-download-alt"></span></a></li>
                    <li><a href="folios_s.php"><span class="glyphicon glyphicon-search" title="Búsqueda de Folios"></span></a></li>
                    <li><a href="activar_s.php" title="Activar Folios"><span class="glyphicon glyphicon-retweet"></span></a></li>

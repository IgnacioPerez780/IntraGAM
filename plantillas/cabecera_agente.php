        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <?php
                    //Querys para validar cuantas notificaciones tiene en total
                    $sql = "SELECT COUNT(*) FROM notificaciones1 WHERE contador='1' and id_agente='$id'";
                    $result = mysqli_query($conexion, $sql);
                    while ($ver = mysqli_fetch_row($result)) {
                        $datos = $ver[0];
                    ?>
                        <li><a href="notificacionesa.php" title="Notificaciones"><span class="glyphicon glyphicon-bell"></span><?php echo $datos;
                                                                                                                            } ?></a></li>

                        <li><a href="menu_agente.php"><span class="glyphicon glyphicon-menu-hamburger"></span> Men&uacute;</a></li>
                        <li><a href="agente.php"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></li>

        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    $sql = "SELECT COUNT(*) FROM notificaciones1_g WHERE contador='1' and id_agente='$id'";
                    $result = mysqli_query($conexion, $sql);
                    while ($ver = mysqli_fetch_row($result)) {
                        $datos = $ver[0];
                    ?>
                        <li><a href="notificacionesa_g.php" title="Notificaciones"><span class="glyphicon glyphicon-bell"></span><?php echo $ver[0];
                                                                                                                                } ?></a></li>
                        <li><a href="menu_agente.php"><span class="glyphicon glyphicon-menu-hamburger"></span> Men&uacute;</a></li>
                        <li><a href="gmmagen.php"><span class="glyphicon glyphicon-chevron-left"></span> Regresar</a></li>

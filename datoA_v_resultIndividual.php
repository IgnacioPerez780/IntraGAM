        ...
        <tr style="background: #FFFFFF;">
            ...
            <td>
                <small>
                    ...
                    if ($periodoIndividual == "semanalIndV") {
                        $sqlPrimaSem = "SELECT FORMAT(SUM(REPLACE(pe.primaAnual,',', '')),2) AS anualizada FROM polizasemitidas pe, folios fl WHERE fl.estado='TERMINADO CON POLIZA' AND fl.id=pe.folio AND DATE(fl.fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND pe.moneda='PESOS' AND fl.id_agente='$id_agente'";
            ...
            <td>
                <small>
                    ...
                    <?php
                    if ($periodoIndividual == "semanalIndV") {
                        $sqlPrimaSem = "SELECT FORMAT(SUM(REPLACE(pe.primaAnual,',', '')),2) AS anualizada FROM polizasemitidas pe, folios fl WHERE fl.estado='TERMINADO CON POLIZA' AND fl.id=pe.folio AND DATE(fl.fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND pe.moneda='DLLS' AND fl.id_agente='$id_agente'";
                        $resultPrimaSem = mysqli_query($conexion, $sqlPrimaSem);
                        while ($verPrimaSem = mysqli_fetch_array($resultPrimaSem)) {
                            $datoPrimaSem = $verPrimaSem[0];
                    ?>
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td class="estatus">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT DISTINCT(estado) FROM folios WHERE t_solicitud = 'ALTA DE POLIZA' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente' ORDER BY estado";
        ...
        <td class="nFolio">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'ALTA DE POLIZA' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente' GROUP BY estado ORDER BY estado";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                        echo $datoEstadoSem . '<br>';
        ...
        <td class="tFolios">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'ALTA DE POLIZA' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente'";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                ?>
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td class="estatus">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT DISTINCT(estado) FROM folios WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente' ORDER BY estado";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                        echo $datoEstadoSem . '<br>';
        ...
        <td class="nFolio">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente' GROUP BY estado ORDER BY estado";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                        echo $datoEstadoSem . '<br>';
        ...
        <td class="tFolios">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente'";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                ?>
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td class="estatus">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT DISTINCT(estado) FROM folios WHERE t_solicitud = 'PAGOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente' ORDER BY estado";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                        echo $datoEstadoSem . '<br>';
        ...
        <td class="nFolio">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'PAGOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente' GROUP BY estado ORDER BY estado";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                        echo $datoEstadoSem . '<br>';
        ...
        <td class="tFolios">
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT COUNT(*) FROM folios WHERE t_solicitud = 'PAGOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente'";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                ?>
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td>
            <small>
                <?php
                if ($periodoIndividual == "semanalIndV") {
                    $sqlEstadoSem = "SELECT COUNT(id) FROM folios WHERE DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND id_agente = '$id_agente'";
                    $resultEstadoSem = mysqli_query($conexion, $sqlEstadoSem);
                    while ($verEstadoSem = mysqli_fetch_array($resultEstadoSem)) {
                        $datoEstadoSem = $verEstadoSem[0];
                ?>

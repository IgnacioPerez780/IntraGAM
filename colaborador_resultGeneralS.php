    ...
    Highcharts.chart('container7', {
        ...
        subtitle: {
            text: 'Total:  <?php
                            ...
                            /*ESTE CODIGO ES PARA MOSTRAR MENSUAL*/
                            if ($periodoGeneral == "7") {
                                $consultSem = "SELECT COUNT(*) FROM folios_s WHERE fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
        ...
        series: [
            ...
            if ($periodoGeneral == "1") {
                ...
                $consultaProspectos = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'VIDA' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                ...
                $consultaProspectos = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'VIDA' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultProspectos = mysqli_query($conexion, $consultaProspectos);
                $prospectos = mysqli_fetch_array($resultProspectos);
                $datosProspectos = $prospectos[0];
            }
            ...
            if ($periodoGeneral == "1") {
                ...
                $date = new DateTime($year . '-' . $month . '-' . $day);
                $fecha = $date->format('Y-m-d');
                $consultaCitas = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'GMM' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            } else {
                $consultaCitas = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'GMM' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            }
            ...
            if ($periodoGeneral == "1") {
                ...
                $date = new DateTime($year . '-' . $month . '-' . $day);
                $fecha = $date->format('Y-m-d');
                $consultaEntrevista = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'AUTOS' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                ...
                $consultaEntrevista = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'AUTOS' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultEntrevista = mysqli_query($conexion, $consultaEntrevista);
                $entrevista = mysqli_fetch_array($resultEntrevista);
                $datosEntrevista = $entrevista[0];
            }
            ...
            if ($periodoGeneral == "1") {
                ...
                $date = new DateTime($year . '-' . $month . '-' . $day);
                $fecha = $date->format('Y-m-d');
                $consultaDaños = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'DAÑOS' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                $resultDaños = mysqli_query($conexion, $consultaDaños);
                $daños = mysqli_fetch_array($resultDaños);
                $datosDaños = $daños[0];
            } else {
                $consultaDaños = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'DAÑOS' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultDaños = mysqli_query($conexion, $consultaDaños);
                $daños = mysqli_fetch_array($resultDaños);
                $datosDaños = $daños[0];
            }

            // MUESTRA DATOS EN LA GRAFICA DEL LADO IZQUIERDO / SEMANAL
            if ($periodoGeneral == "7"){
                $consultaProspectos = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'VIDA' AND fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
                $resultProspectos = mysqli_query($conexion, $consultaProspectos);
                $prospectos = mysqli_fetch_array($resultProspectos);
                $datosProspectos = $prospectos[0];
            }
            ...
            if ($periodoGeneral == "7"){
                $consultaCitas = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'GMM' AND fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            }
            ...
            if ($periodoGeneral == "7") {
                $consultaEntrevista = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'AUTOS' AND fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
                $resultEntrevista = mysqli_query($conexion, $consultaEntrevista);
                $entrevista = mysqli_fetch_array($resultEntrevista);
                $datosEntrevista = $entrevista[0];
            }
            ...
            if ($periodoGeneral == "7") {
                $consultaDaños = "SELECT COUNT(*) FROM folios_s WHERE linea_s = 'DAÑOS' AND fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
                $resultDaños = mysqli_query($conexion, $consultaDaños);
                $daños = mysqli_fetch_array($resultDaños);
                $datosDaños = $daños[0];
            }

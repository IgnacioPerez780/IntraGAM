...
$periodoCuatrimestralInd_v = $_POST['periodoCuatrimestralInd_v'];
...
if ($periodoInd_v == "3ind_v") {
    $day = "01";
    $mes = $_POST['periodoTrimestralInd'];
    $year = $_POST['añoInd_v'];
...
<script type="text/javascript">
    ...
    Highcharts.chart('container2Ind', {
        ...
        title: {
            text: 'PRODUCTOS DE ALTA DE PÓLIZA <?php if ($periodoInd_v == "1ind_v") {
                                                ...
                                                if ($periodoInd_v == "3ind_v") {
                                                    echo "TRIMESTRE " . $periodoTrimestralInd . " AÑO " . $añoInd_v;
                                                }
                                                if ($periodoInd_v == "5ind_v") {
  ...
  // GRAFICA MOVIMIENTOS
    Highcharts.chart('container3Ind', {
        ...
        title: {
            text: 'PRODUCTOS DE MOVIMIENTOS <?php if ($periodoInd_v == "1ind_v") {
                                                echo "EN " . $meses . " " . $añoInd_v;
                                            }
                                            if ($periodoInd_v == "7ind_v") {
                                                $dateSem1 = date_create($periodoSemInd1_v);
    ...
    Highcharts.chart('container4Ind', {
        ...
        title: {
            text: 'TIPO DE MONEDA EN PAGOS  <?php if ($periodoInd_v == "1ind_v") {
                                                echo "EN " . $meses . " " . $añoInd_v;
                                            }
                                            if ($periodoInd_v == "7ind_v") {
                                                $dateSem1 = date_create($periodoSemInd1_v);

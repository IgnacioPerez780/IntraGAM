...
<head>
    ...
    <script src="js/main_siniestros_consultor.js"></script>
        ...
        <div class="col-sm-12">
            <table class="table table-condensed table-bordered" id="tablaDinamicaLoad">
                ...
                <tbody>
                    <tr class="comentarios">
                        ...
                        <td colspan="5">
                            <b>
                                <p style="color:#FFFFFF">Observaciones</p>
                            </b>
                        </td>
                        <td>
                            <b>
                                <p style="color:#FFFFFF">Estado
                            </b></p>
                        </td>
                        <td>
                            <b>
                                <p style="color:#FFFFFF">Fecha y hora</p>
                            </b>
                        </td>
                    </tr>
         ...
         <a  style="color: black"
            ...
            <?php if ($ver[14] == "ENVIADO" || $ver[14] == "INCOMPLETO" || $ver[14] == "PROCESO" || $ver[14] == "PROCESO GNP" || $ver[14] == "REPROCESO") { ?>
                ...
                <!-- Archivos (Barra de Progreso en TODOS LOS ESTADOS )-->
                <tbody>
           ...
           <a  style="color: black"
            ...
            <?php if ($ver[14] == 'TERMINADO') { ?>
                ...
                <!-- ARCHIVOS (Barra de Progreso para el Estado TERMINADO)-->
                <tbody>
                    <form action="" id="form_subir" enctype="multipart/form-data">
                        <input type="text" hidden="" id="nomusuario" name="nomusuario" value="<?php echo "$nomusuario"; ?>">
                        <input type="text" hidden="" id="idf" name="idf" value="<?php echo "$ids"; ?>">
                ...
                <tbody>
                    <tr class="comentarios">
                        ...
                        <td>
                            <b>
                                <p style="color:#FFFFFF">Usuario
                            </b>
                        </td>
                        <td colspan="5">
                            <b>
                                <p style="color:#FFFFFF">Observaciones:
                            </b>
                        </td>
                        <td>
                            <b>
                        ...
                        <td>
                            <b>
                                <p style="color:#FFFFFF">Fecha y hora:
                            </b>
                        </td>
                    </tr>

...
foreach ($_POST['valido'] as $idvalido) {
    ...
    $id = "select id_agente from folios_s where id='$idf'";
    ...
    $consulta = "insert into validar_archivos_s set idarchivo='$idvalido'";
    //echo $consulta.'<br />';
...
echo '<script type="text/javascript">
	jQuery(function(){   
		...
		function(){
			window.location.href = "seguimiento_s_c.php?id=' . $idf . '";
		})
	});
  </script>';
?>
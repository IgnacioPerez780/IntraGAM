...
foreach ($_POST['valido'] as $idvalido) {
    ...
    $id = "select agente from folios_g where id='$idf'";
    ...
    $consulta = "insert into validar_archivos_g set id_archivo='$idvalido'";
    //echo $consulta.'<br />';
...
echo '<script type="text/javascript">
	jQuery(function(){   
		...
		function(){
			window.location.href = "seguimiento_g_c.php?id=' . $idf . '";
		})
	});
  </script>';
?>
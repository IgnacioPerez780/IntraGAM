        ...
        <div class="row">
            <div class="col-sm-5 col-sm-offset-3">
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <button type="submit" class="btn-load btn-lgcol-xs-12 btn btn-primary" name="enviar" id="actualizarPass" disabled>Actualizar</button>
                </form>
            </div>
        </div>
    </div>
    ...
    if (mysqli_num_rows($verificar) > 0) {
        ...
        if ($res) {
            ...
            jQuery(function () {
                swal({
                    ...
                    function () {
                        window.location.href = "actividad_portal.php";
                    })
            });
            </script> ';
        } else {
        ...
        jQuery(function () {
            swal({
                ...
                function () {
                    window.location.href = "actualizar_pass3.php";
                })
        });
        </script> ';

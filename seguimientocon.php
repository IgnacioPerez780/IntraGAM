...
if (isset($_SESSION['logged_in'])) {
    ...
    if (isset($_SESSION["timeout"])) {
        ...
        if ($sessionTTL > $inactive) {
            ...
            if ($nomusuario == "Veronica S" || $nomusuario == "Giovanni M" || $nomusuario == "Karla B" || $nomusuario == "Diana C" || $nomusuario == "Carolina H" || $nomusuario == "Dante V" || $nomusuario == "Manuel R") {
...
<head>
 ...
 <!-- HOJAS DE ESTILO -->
    ...
    <script src="js/main_vida_consultor.js"></script>
...
<!--SE CARGAN DESPUES DE LAS CABECERAS PARA NO AFECTAR EL CODIGO DEL TOOLTIP CON DETALLES-->
...
<body <?php if (in_array($ids, $categorias2)) {
    ...
    <div class="container">
        <div class="col-sm-12">
            <table class="table table-condensed table-bordered" id="tablaDinamicaLoad">
                <tbody>
                    <tr>
                        <td class="seguimiento" colspan="8" align="center">
                            <b>
                                <h2>
                                    <p>Seguimiento de <?php echo $nomusuario; ?>
                                </h2>
                            </b>
                        </td>
                    </tr>
                    ...
                    while ($ver = mysqli_fetch_row($result)) {
                        ...
                        <tr>
                            <td colspan="8" align="center" class="nombreAgente">
                                <b>
                        ...
                        <?php if ($ver[14] == 'CANCELADO') { ?>
                            ...
                            <?php if ($ver[3] == "ALTA DE POLIZA") { ?>
                                <tr>
                                    <td align="center" bgcolor="#FFF"><b>Folio:</b></td>
                                    <td align="center" bgcolor="#FFF"><input type="text" value="<?php echo "$ids"; ?>" id="folio" name="folio" disabled></td>
                                    <td align="center" bgcolor="#FFF"><b>Línea de Negocio:</b></td>
                                    <td align="center" bgcolor="#FFF"><?php echo $ver[2]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Fecha Solicitud:</b></td>
                                    <td align="center" bgcolor="#FFF"><?php echo $ver[1]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Estado:</b></td>
                                    <td align="center" <?php
                                ...
                                <tr>
                                    <td align="center" bgcolor="#FFF"><b>Contratante:</b></td>
                                    <td colspan="4" align="center" bgcolor="#FFF"><?php echo $ver[11]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Póliza:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><?php echo  $ver[17]; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#FFF"><b>Tipo Solicitud:</b></td>
                                    <td align="center" bgcolor="#FFF"><?php echo $ver[3]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Producto:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><?php echo $ver[4]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Rango:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><?php echo $ver[5]; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2" align="center" bgcolor="#FFF"><b>Prima:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF">$ <?php echo $ver[7]; ?></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><b>Moneda:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><?php echo $ver[18]; ?></td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#FFF"><b>Prioridad:</b></td>
                                    <td align="center" bgcolor="#FFF"><?php echo $ver[12]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Comentarios:</b></td>
                                    <td colspan="6" align="center" bgcolor="#FFF"><?php echo $ver[13]; ?></td>
                                </tr>
                                <tr>
                                    <td colspan="8" align="center" bgcolor="#eeefef"><b></b></td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2" align="center" bgcolor="#FFF"></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><b>Folio GNP:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><?php echo $ver[16]; ?></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"></td>
                                </tr>
                            ...
                            <?php } elseif ($ver[3] == "MOVIMIENTOS") { ?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="4" align="center" bgcolor="#FFF"><?php echo $ver[11]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Póliza:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><?php echo  $ver[8]; ?></td>
                                </tr>
                                <tr>
                                    <td colspan="8" align="center" bgcolor="#eeefef"><b></b></td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#FFF"><b>Tipo Solicitud:</b></td>
                                    <td align="center" bgcolor="#FFF"><?php echo $ver[3]; ?></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><b>Tipo de Movimiento:</b></td>
                                    <td colspan="6" align="center" bgcolor="#FFF"><?php echo $ver[9]; ?></td>
                                </tr>
                                <tr>
                                    <td colspan="8" align="center" bgcolor="#eeefef"><b></b></td>
                                </tr>
                            ...
                            <?php } elseif ($ver[3] == "PAGOS") { ?>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#FFF"><b>Tipo Solicitud:</b></td>
                                    <td align="center" bgcolor="#FFF"><?php echo $ver[3]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Monto:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF">$ <?php echo $ver[10]; ?></td>
                                    <td align="center" bgcolor="#FFF"><b>Moneda:</b></td>
                                    <td colspan="2" align="center" bgcolor="#FFF"><?php echo $ver[19]; ?></td>
                                </tr>
                                <tr>
                                    <td colspan="8" align="center" bgcolor="#eeefef"><b></b></td>
                                </tr>
                            ...
                            <!-- AGREGAR ARCHIVOS (BARRA DE PROGRESO EN TODOS LOS ESTADOS - MENOS CANCELADOS Y TERMINADOS)-->
                            <form action="" enctype="multipart/form-data" id='filesform'>
                                ...
                                <tr>
                                    <td colspan="9" align="center">
                                        <div class="acciones">
                                            <button type="submit" onclick="return subir()" class="btn btn-primary" id="subirV" disabled>Subir Archivo</button>
         ...
         <a  style="color: black"
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                  ...
                  <div style='width:240px;background:#F2F2F2;line-height:30px;float:left;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    <strong>
                       ...
                       if($modificacion['extension'] > 1){                         echo $extension = " Ext ";                         if($modificacion['extension'] > 1){                         echo $extension = " Ext ";                         }}
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    "> <!-- SE CIERRA LA ETIQUETA A CON EL TOOLTIP -->
                            ...
                            <!-- TERMINA EL CODIGO -->
                                    ...
                                    <td colspan="5" align="center" style="vertical-align: middle;"><?php echo $ver1[2]; ?></td>
                        ...
                        <tr class="observaciones">
                            <td colspan="8" align="center">
                                ...
                                <button style="display: none" type="button" id="guardar2" class="btn btn-warning glyphicon glyphicon-ok"></button>
                            </td>
                        </tr>
                    ...
                    <?php if ($ver[14] == 'ACTIVADO MED' || $ver[14] == 'ACTIVADO FLT' || $ver[14] == 'ACTIVADO GNP' || $ver[14] == 'PROCESO' || $ver[14] == 'REPROCESO' || $ver[14] == 'ENVIADO') { ?>
                        ...
                        <?php if ($ver[3] == "ALTA DE POLIZA") { ?>
                            ...
                            <tr>
                                <td align="center" style="background-color: #FFF;"><b>Contratante:</b></td>
                                <td colspan="4" align="center" style="background-color: #FFF;"><?php echo $ver[11]; ?></td>
                                <td align="center" style="background-color: #FFF;"><b>Póliza:</b></td>
                                <td colspan="2" align="center" style="background-color: #FFF;"><?php echo  $ver[17]; ?></td>
                            </tr>
                            ...
                            <tr>
                                <td align="center" style="background-color: #FFF;"><b>Tipo Solicitud:</b></td>
                                <td align="center" style="background-color: #FFF;"><?php echo $ver[3]; ?></td>
                                <td align="center" style="background-color: #FFF;"><b>Producto:</b></td>
                                <td colspan="2" align="center" style="background-color: #FFF;"><?php echo $ver[4]; ?></td>
                                <td align="center" style="background-color: #FFF;"><b>Rango:</b></td>
                                <td colspan="2" align="center" style="background-color: #FFF;"><?php echo $ver[5]; ?></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" align="center" style="background-color: #FFF;"><b>Prima:</b></td>
                                <td colspan="2" align="center" style="background-color: #FFF;">$ <?php echo $ver[7]; ?></td>
                                <td colspan="2" align="center" style="background-color: #FFF;"><b>Moneda:</b></td>
                                <td colspan="2" align="center" style="background-color: #FFF;"><?php echo $ver[18]; ?></td>
                            </tr>
                            ...
                            <tr>
                                <td align="center" style="background-color: #FFF;"><b>Prioridad:</b></td>
                                <td align="center" style="background-color: #FFF;"><?php echo $ver[12]; ?></td>
                                <td align="center" style="background-color: #FFF;"><b>Comentarios:</b></td>
                                <td colspan="6" align="center" style="background-color: #FFF;"><?php echo $ver[13]; ?></td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2" align="center" style="background-color: #FFF;"></td>
                                <td colspan="2" align="center" style="background-color: #FFF;"><b>Folio GNP:</b></td>
                                <td colspan="2" align="center" style="background-color: #FFF;"><?php echo $ver[16]; ?></td>
                                <td colspan="2" align="center" style="background-color: #FFF;"></td>
                            </tr>
                        ...
                        <?php } elseif ($ver[3] == "MOVIMIENTOS") { ?>
                            <!--CIERRE ALTA POLIZA (TODOS LOS ESTADOS)-->
                        ...
                        <?php } elseif ($ver[3] == "PAGOS") { ?>
                            <!--CIERRE MOVIMIENTOS (TODOS LOS ESTADOS)-->
                        ...
                        <?php } ?>
                        <!--CIERRE PAGOS (TODOS LOS ESTADOS)-->
                        ...
                        <tr align="center" class="datosDocument">
                            <td colspan="1" align="center"><b>Usuario</td>
                            <td colspan="2" align="center"><b>Nombre de Archivo</td>
                            <td colspan="1" align="center"><b>Ver</td>
                            <td colspan="1" align="center"><b>Descargar</td>
                            <td colspan="2" align="center"><b>¿Aprobado?</td>
                            <td colspan="1" align="center"><b>Fecha de carga</td>
                        </tr>
           ...
           <a  style="color: black"
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                  ...
                  <div style='width:240px;background:#F2F2F2;line-height:30px;float:left;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    <strong>
                        ...
                        echo $modificacion['telefono']; 
                       if($modificacion['extension'] > 1){                         echo $extension = " Ext ";                         }
            ...
            <tr class="observaciones">
                ...
                <td colspan="2" align="center"><b>Asignar folio GNP:</b></td>
                <td colspan="2" align="center"><input type="text" value="<?php echo $ver[16]; ?>" id="fgnp" name="fgnp"></td>
            </tr>
            ...
            <tr class="observaciones">
                ...
                <td colspan="2" align="center"><b>Asignar póliza GNP:</b></td>
                <td colspan="2" align="center"><input type="text" value="<?php echo  $ver[8]; ?><?php echo  $ver[17]; ?>" id="polizap" name="polizap"></td>
            </tr>
    ...
    <!--COMIENZA EL MODAL PARA TERMINADOS-->
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">TERMINADO CON PÓLIZA</h4>
                </div>
                <div class="modal-body">

                    <label>PRIMA:</label><br>
                    <center> <input type="text" name="prima2" id="prima2" class="number form-control input-sm" placeholder="Escribe la prima correspondiente" maxlength="20" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" /></center><i>(Máximo 20 digitos)</i><br>
...
<?php if ($ver[14] == 'TERMINADO' || $ver[14] == 'TERMINADO CON POLIZA') { ?>
    ...
    <?php } elseif ($ver[3] == "MOVIMIENTOS") { ?>
        <!--CIERRE DE ALTA POLIZA (TERMINADOS)-->
    ...
    <?php } elseif ($ver[3] == "PAGOS") { ?>
        <!--CIERRE DE MOVIMIENTOS (TERMINADOS)-->
    ...
    <!-- AGREGAR ARCHIVOS (BARRA DE PROGRESO PARA ESTADOS TERMINADOS)-->
    <tbody>
        <form action="anexar.php" method="post" enctype="multipart/form-data" id='filesform'>
            ...
            <tr>
                <td colspan="9" align="center">
                    <div class="acciones">
                        <button type="submit" onclick="return subir()" class="btn btn-primary">Subir Archivo</button>
                        <input type="button" class="btn btn-danger" id="cancelar" value="Cancelar" disabled>
                    </div>
                </td>
            </tr>
...
<?php } ?>
<!--CIERRE DE LOS TERMINADOS-->

<?php } ?>
<!--CIERRE DEL WHILE FOLIOS-->
        ...
        $('#guardar').click(function() {
            ...
            if (estado == 'PROCESO') {
                if (comentario.length == 0) {
                    swal({
                        title: "¡Error!",
                        text: "Ingresa un comentario justificando el Cambio de Estado",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });
                    ...
                    swal({
                        title: "¡Error!",
                        text: "Ingresa el Folio GNP correspondiente",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });
            ...
            if (estado == 'TERMINADO CON POLIZA') {
                if (comentario.length == 0) {
                    ...
                    swal({
                        title: "¡Error!",
                        text: "Asigna la Póliza GNP correspondiente",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });
        ...
        $('#guardarM').click(function() {
            ...
            if (estado == 'TERMINADO CON POLIZA') {
                if (comentario.length == 0) {
                    ...
                    swal({
                        title: "¡Error!",
                        text: "Ingresa la Póliza GNP correspondiente",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });
                    ...
                    swal({
                        title: "¡Error!",
                        text: "Ingresa la Prima correspondiente",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });
                    ...
                    swal({
                        title: "¡Error!",
                        text: "Selecciona una opción del combo Moneda",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });
                    ...
                    swal({
                        title: "¡Error!",
                        text: "Selecciona el Periodo correspondiente",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });

...
<body>
    ...
    <div class="container">
        <?php include('componentes/tabla_acti_s.php'); ?>
    </div>

    <!--Conexion -->
    <div class="modal fade" id="modalUpload_s" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button href="#" class="btn btn-primary" type="button" id="guardar-form" onclick="return validar_s()" id="btnreload"> ACTIVAR</button>
                    </div>

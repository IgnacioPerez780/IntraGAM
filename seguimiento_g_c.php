                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    "> <!-- SE CIERRA LA ETIQUETA A CON EL TOOLTIP -->
                        ...
                        <tr class="observaciones">
                            ...
                            <td colspan="2" align="center" class="observaciones"><input type="text" value="<?php echo $ver[6]; ?>" id="fgnp" name="fgnp" disabled></td>
                        </tr>
                        <tr class="observaciones">
                            ...
                            <td colspan="2" align="center" class="observaciones"><input type="text" value="<?php echo  $ver[5]; ?>" id="poliza" name="poliza" disabled></td>
                        </tr>
                        <tr class="observaciones">
                            <td colspan="8" align="center">
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    <tr class="observaciones">
                        ...
                        <td colspan="2" align="center" class="observaciones"><b>Asignar folio GNP:</b></td>
                        <td colspan="2" align="center" class="observaciones"><input type="text" value="<?php echo $ver[6]; ?>" id="fgnp" name="fgnp"></td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" class="observaciones"><b></b></td>
                        <td colspan="2" align="center" class="observaciones"></td>

                        <td colspan="2" align="center" class="observaciones"><b>Asignar póliza GNP:</b></td>
                        <td colspan="2" align="center" class="observaciones"><input type="text" value="<?php echo  $ver[5]; ?>" id="poliza" name="poliza"></td>
                    </tr>
                    <tr class="observaciones">
                        <td colspan="8" align="center">

...
$cont = "UPDATE notificaciones1_g set contador='0' where folio='$ids'";
...
<!-- termina codigo alertas
 -->
    ...
    <script src="js/main_gmm_agente.js"></script>
...
<?php
include('plantillas/cabecera_agente_g.php');
?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-header">
            <h3 class="modal-title">SOLICITUD CONCLUIDA</h3>
          ...
          <div class="modal-body">
            <h4>
                    Tu solicitud ha sido concluida con éxito, por favor revisa la documentación anexa y ayúdanos a corroborar que cumpla los criterios necesarios de acuerdo con lo solicitado, en tal caso, acepta los términos en los que fue resulta tu solicitud para poder descargar la caratula de tu poliza.
                    <br>
                    <br>
                Si existe alguna inconsistencia favor de notificar de manera inmediata al consultor a través de este medio.
                Gracias.
            </h4>
          </div>
...
<div id="pregunta3" style="display:none;" class="form-check-input" align="center" style="text-align: center;">
    ...
    <label class="btn ">
        ...
        <div id="pregunta4" style="display:none;" class="form-check-input" align="center" style="text-align: center;">
                      <h4> <p> 4.- ¿El consultor solicitó toda la documentación necesaria para la gestión de tu solicitud desde el inicio?  </p> </h4>  
                      <br>
            ...
            <table class="table table-condensed table-bordered" id="tablaDinamicaLoad">
                <tbody>
                    ...
                    ?>
                        ...
                        <!-- CONDICION CANCELADOS Y RECHAZADOS -->
                            ...
                            <form class="" action="validar_g.php" method="post">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td colspan="1" align="center" <?php  if ($respondido != $ids && $terminado == '1' ) { ?> onclick="return abrirmodal();" <?php } ?>> <a href="../sistemas/archivos_g/<?php echo $row[1]; ?>" target=" _blank">
...
<!--                          TERMINA CODIGO PARA EL BOTON           
 -->                                    </td>
                            ...
                            <form enctype="multipart/form-data" id="filesformga">
                                <tr>
                    ...
                    "> <!-- SE CIERRA LA ETIQUETA A CON EL TOOLTIP -->
                        ...
                        <tr class="observaciones">
                            ...
                            <td colspan="2" align="center">
                                <button type="button" class="btn btn-warning glyphicon glyphicon-ok" id="guardar4" disabled></button>
                            </td>
                        </tr>

                        <!-- CIERRE CONDICION CANCELADOS/RECHAZADOS -->
                    <?php } ?>

                    <!-- ENTRAN TODOS LOS ESTADOS MENOS / CANCELADOS-RECHAZADOS-TERMINADOS -->
                    <?php if ($ver[14] == 'CASO ESPECIAL' || $ver[14] == 'ACTIVADO MED' || $ver[14] == 'ACTIVADO FLT' || $ver[14] == 'ACTIVADO GNP' || $ver[14] == 'PROCESO' || $ver[14] == 'REPROCESO' || $ver[14] == 'ENVIADO') { ?>
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    <tr class="observaciones">
                        ...
                        <td colspan="2" align="center">
                            <button type="button" class="btn btn-warning glyphicon glyphicon-ok" id="guardar4"></button>
                        </td>
                    </tr>
                    <!-- CIERRE CONDICIÓN DE TODOS LOS ESTADOS -->
                <?php } ?>

                <!-- CONDICIÓN PARA TERMINADO Y TERMINADOS CON POLIZA  -->
 ...
 -->                                    </td>
           ...
           <a  style="color: black"
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                ...
                <tr class="observaciones">
                    <td colspan="2" align="justify" style="width:30px;"><small><b>De acuerdo a la Circular 16 de GNP donde se solicita la documentación física en original sin tachaduras ni enmendaduras,
                    ...
                    <td colspan="5" align="center">
                        <form action="validar-checkbox_g.php" method="post">
                            <div class="checkbox" id="checkbox_g" align="center">
                                <input type="checkbox" style="display: none" id="checkbox1_g" name="condiciones[<?php echo $ids; ?>]" value="<?php echo "$ids"; ?>" onclick="validarcheck_g()">
                                <label style="font-weight:bold;color:#FFFFFF" for="checkbox1_g">Acepto términos y condiciones bajo los que fue resuelta mi solicitud.</label required>
                                <br><button type="submit" class="btn btn-warning glyphicon glyphicon-ok" id="aceptar_g" style="display: none"></button></br>
                            </div>
                        </form>
            ...
            <!--CIERRE DEL WHILE DE LA LINEA 137 CONSULTA GENERAL-->
        <?php } ?>
 ...
 $(document).ready(function() {
    ...
    $(document).ready(function() {
        $('#guardar4').click(function() {
            ...
            if (estado == 'ENVIADO' || estado == 'ACTIVADO FLT' || estado == 'ACTIVADO MED' || estado == 'ACTIVADO GNP' || estado == 'INCOMPLETO' || estado == 'PROCESO' || estado == 'PROCESO GNP' || estado == 'REPROCESO' || estado == 'TERMINADO' || estado == 'CASO ESPECIAL' || estado == 'TERMINADO CON POLIZA') {
...
<script type="text/javascript">
    function conformidad_g() {
        ...
        document.getElementById("checkbox1_g").checked = true;
        document.getElementById("checkbox1_g").disabled = true;

    }

    function validarcheck_g() {
        var opcion = document.getElementById('checkbox1_g');
        if (opcion.checked == true) { //botón seleccionado
            document.getElementById("aceptar_g").style.display = 'block';

        } else { //botón no seleccionado
            document.getElementById("aceptar_g").style.display = 'none';
...
<script type="text/javascript">
    $('#agregar1').bind('change', function() {
        if (this.files[0].size > 7000000) { //De KB A BYTES
            swal({
                title: "¡Error!",
                text: "Solo se permiten archivos menores a 5 MB. \n Te recomendamos comprimirlos en ¡LovePDF ó Smallpdf",
                type: "error",
                customClass: 'swal-wide',
                allowOutsideClick: false
            });

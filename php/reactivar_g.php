<?php 
    ...
    $sql = "INSERT INTO activados_g(folio_g,usuario_g,tipo_g,detalles_g,fecha_g) VALUES ('$folio','$nomusu','$tipo','$motivo','$fec1')";
    $result = mysqli_query($conexion,$sql);
    
    //SE HACE EL UPDATE EN LA TABLA DE FOLIOS DONDE EL ESTADO CAMBIA DE CANCELADO A ENVIADO POR DEFAULT
    $sql1 = "UPDATE folios_g set estado='ENVIADO' WHERE id='$folio'";
    ...
    $sql2 = "INSERT INTO comentarios_g(fecha_comentario,comentarios,folio,usuario,estado1) VALUES ('$fec1','$comen','$folio','$nomusu','ENVIADO')";
    ...
    $sql3 = "INSERT INTO notificaciones_g(folio,usuario,estado,fecha,tipo,contador) VALUES ('$folio','$nomusu','ENVIADO','$fec1','REACTIVACION','1')";

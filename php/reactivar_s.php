<?php 
    ...
    $sql = "INSERT INTO activados_s(folio_s,usuario_s,tipo_s,detalles_s,fecha_s) VALUES ('$folio','$nomusu','$tipo','$motivo','$fec1')";
    $result = mysqli_query($conexion,$sql);
    
    //SE HACE EL UPDATE EN LA TABLA DE FOLIOS DONDE EL ESTADO CAMBIA DE CANCELADO A ENVIADO POR DEFAULT
    $sql1 = "UPDATE folios_s set estado='ENVIADO' WHERE id='$folio'";
    ...
    $sql2 = "INSERT INTO comentarios_s(fecha_comentario,comentario,folio,usuario,estado) VALUES ('$fec1','$comen','$folio','$nomusu','ENVIADO')";
    ...
    $sql3 = "INSERT INTO notificaciones_s(folio,usuario,estado,fecha,tipo,contador) VALUES ('$folio','$nomusu','ENVIADO','$fec1','REACTIVACION','1')";

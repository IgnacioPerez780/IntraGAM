<?php
    ...
    elseif (isset($_FILES['file'])) {
        ...
        foreach($_FILES as $key => $tmp_name) {
            ...
            //$nameArchivo = substr($archivo, 0, strlen($archivo)-4);
            $destino =  $carpeta .'name'.$id_folio.'.pdf';
            $copy = guardar_pdf($destino, $archivo_temp , $carpeta, $id_folio, $nomusu);
            return "archivo guardado";
        }
    }
    elseif ($_POST['datos']) {
        ...
        if (isset($post[17])) {
            ...
            $sql = "INSERT INTO
                ...
                values  ('$fec1','$neg','$t_s','$pro','$ran','$mon','$pri','$pol','$mov','$mon','$con','$pad','$com','$est','$id','$pop','$mop','$mopa','0')";
    ...
    function guardar_pdf($destino, $archivo_temp, $carpeta ,$id_folio ,$nomusu){
       if(!is_dir($carpeta)){
        ...
        /*var_dump($archivo_temp); var_dump($destino); var_dump(is_dir($carpeta)); var_dump($carpeta);*/

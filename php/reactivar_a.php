<?php 
    ...
    $sql = "INSERT INTO activados_a(folios_a,usuario_a,tipo_a,detalles_a,fecha_a) VALUES ('$folio','$nomusu','$tipo','$motivo','$fec1')";
    $result = mysqli_query($conexion,$sql);
    
    //SE HACE EL UPDATE EN LA TABLA DE FOLIOS DONDE EL ESTADO CAMBIA DE CANCELADO A ENVIADO POR DEFAULT
    $sql1 = "UPDATE folios_a set estado='ENVIADO' WHERE id='$folio'";
    ...
    $sql2 = "INSERT INTO comentarios_a(fecha_comentario,comentarios,folio,usuario,estado1) VALUES ('$fec1','$comen','$folio','$nomusu','ENVIADO')";
    $result2 = mysqli_query($conexion,$sql2);

    //SE HACE UN INSERT EN LA TABLA DE NOTIFICACIONES PARA EL CONSULTOR, EL CUAL LE AVISARA QUE TIENE UN CAMBIO DE ESTADO EN SU TRAMITE
    $sql3 = "INSERT INTO notificaciones_a(folio,usuario,estado,fecha,tipo,contador) VALUES ('$folio','$nomusu','ENVIADO','$fec1','REACTIVACION','1')";

<?php
    ...
    if ($_POST['datos']) {
        ...
        if (isset($post[31])) {
            ...
            if($neg == "GMM"){
                $sql = "INSERT INTO
                    folios_s(fecha,linea_s,tipo_sol,total,gastos_no,monto_pro,contratante,n_poliza,n_siniestro,n_qr,n_reclamacion,n_folio,descripcion,estado,id_agente,afectado,usuario)
                values  ('$fec1','$neg','$t_s','$tot','$gas','$mon','$con','$nmp','$nms','$nmq','$nmr','$nmf','$des','$est','$id','$afe','0')";
                ...
                $sql = "INSERT INTO
                    folios_s(fecha,linea_s,tipo_sol,total,gastos_no,monto_pro,contratante,n_poliza,n_siniestro,n_qr,n_reclamacion,n_folio,descripcion,estado,id_agente,afectado,usuario)
                values  ('$fec1','$neg','$t_v','$tot','$gas','$mon','$cov','$nmv','$nms','$nmq','$nmr','$nmf','$desv','$est','$id','N/A','0')";
                ...
                $sql = "INSERT INTO
                    folios_s(fecha,linea_s,tipo_sol,total,gastos_no,monto_pro,contratante,n_poliza,n_siniestro,n_qr,n_reclamacion,n_folio,descripcion,estado,id_agente,afectado,usuario)
                values  ('$fec1','$neg','$t_a','$tot','$gas','$mon','$coa','$nma','$nmsa','$nmqa','$nmr','$nmf','$desa','$est','$id','N/A','0')";
                ...
                $sql = "INSERT INTO
                    folios_s(fecha,linea_s,tipo_sol,total,gastos_no,monto_pro,contratante,n_poliza,n_siniestro,n_qr,n_reclamacion,n_folio,descripcion,estado,id_agente,afectado,usuario)
                values  ('$fec1','$neg','$t_d','$tot','$gas','$mon','$cod','$nmd','$nmsd','$nmqd','$nmr','$nmf','$desd','$est','$id','N/A','0')";

    ...
    <tr style="background: #FFFFFF;">
        ...
        <td class="estatus">
            <small>
                ...
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoSemInd = "SELECT DISTINCT(estado) FROM folios_a WHERE t_solicitud = 'NUEVO NEGOCIO' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' ORDER BY estado";
        ...
        <td class="nFolio">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoSemInd = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'NUEVO NEGOCIO' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' GROUP BY estado ORDER BY estado";
                    $resultEstadoSemInd = mysqli_query($conexion, $sqlEstadoSemInd);
                    while ($verEstadoSemInd = mysqli_fetch_array($resultEstadoSemInd)) {
                        $datoEstadoSemInd = $verEstadoSemInd[0];
                        echo $datoEstadoSemInd . '<br>';
        ...
        <td class="tFolios">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoSemInd = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'NUEVO NEGOCIO' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                    $resultEstadoSemInd = mysqli_query($conexion, $sqlEstadoSemInd);
                    while ($verEstadoSemInd = mysqli_fetch_array($resultEstadoSemInd)) {
                        $datoEstadoSemInd = $verEstadoSemInd[0];
                ?>
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td class="estatus">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoSemInd = "SELECT DISTINCT(estado) FROM folios_a WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' ORDER BY estado";
                    $resultEstadoSemInd = mysqli_query($conexion, $sqlEstadoSemInd);
                    while ($verEstadoSemInd = mysqli_fetch_array($resultEstadoSemInd)) {
                        $datoEstadoSemInd = $verEstadoSemInd[0];
                        echo $datoEstadoSemInd . '<br>';
        ...
        <td class="nFolio">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoSemInd = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' GROUP BY estado ORDER BY estado";
                    $resultEstadoSemInd = mysqli_query($conexion, $sqlEstadoSemInd);
                    while ($verEstadoSemInd = mysqli_fetch_array($resultEstadoSemInd)) {
                        $datoEstadoSemInd = $verEstadoSemInd[0];
                        echo $datoEstadoSemInd . '<br>';
        ...
        <td class="tFolios">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoSemInd = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                    $resultEstadoSemInd = mysqli_query($conexion, $sqlEstadoSemInd);
                    while ($verEstadoSemInd = mysqli_fetch_array($resultEstadoSemInd)) {
                        $datoEstadoSemInd = $verEstadoSemInd[0];
                ?>
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td>
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoSemInd = "SELECT COUNT(*) FROM folios_a WHERE DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                    $resultEstadoSemInd = mysqli_query($conexion, $sqlEstadoSemInd);
                    while ($verEstadoSemInd = mysqli_fetch_array($resultEstadoSemInd)) {
                        $datoEstadoSemInd = $verEstadoSemInd[0];
                ?>
                    ...
                    $sqlEstadoM = "SELECT COUNT(id) FROM folios_a WHERE MONTH(fecha) = '$monthIndM' AND YEAR(fecha) = '$yearIndM' AND agente = '$id_agente'";
                    $resultEstadoM = mysqli_query($conexion, $sqlEstadoM);
                    while ($verEstadoM = mysqli_fetch_array($resultEstadoM)) {
                        $datoEstadoM = $verEstadoM[0];
                    ?>
                    ...
                    if ($monthIndividualC == "primerCind") {
                        ...
                        $sqlEstadoC = "SELECT COUNT(id) FROM folios_a WHERE fecha BETWEEN '$fecha1Cind' AND '$resultFechaCind' AND agente = '$id_agente'";
                        $resultEstadoC = mysqli_query($conexion, $sqlEstadoC);
                        while ($verEstadoC = mysqli_fetch_array($resultEstadoC)) {
                            $datoEstadoC = $verEstadoC[0];
                        ?>
                    ...
                    if ($monthIndividualS == "primerSind") {
                        ...
                        $sqlEstadoS = "SELECT COUNT(id) FROM folios_a WHERE fecha BETWEEN '$fechaIndividualS1' AND '$resultFechaSind' AND agente = '$id_agente'";
                        $resultEstadoS = mysqli_query($conexion, $sqlEstadoS);
                        while ($verEstadoS = mysqli_fetch_array($resultEstadoS)) {
                            $datoEstadoS = $verEstadoS[0];
                        ?>
                    ...
                    $sqlEstadoS = "SELECT COUNT(id) FROM folios_a WHERE fecha BETWEEN '$fechaIndividualY1' AND '$resultFechaY' AND agente = '$id_agente'";
                    $resultEstadoS = mysqli_query($conexion, $sqlEstadoS);
                    while ($verEstadoS = mysqli_fetch_array($resultEstadoS)) {
                        $datoEstadoS = $verEstadoS[0];
                        ?>

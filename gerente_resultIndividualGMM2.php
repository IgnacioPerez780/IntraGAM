                ...
                ?>[
                    ...
                    while ($producto = mysqli_fetch_array($resultProducto)) {
                        ...
                        if ($periodoInd == "1") {
                            ...
                            $consultaProduct = "SELECT COUNT(producto) FROM folios_g WHERE producto = '$datosProducto' AND t_solicitud = 'ALTA POLIZA NACIONAL' AND MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year' AND agente = '$id_agente'";
                        } else {
                ...
                ?>[
                    ...
                    while ($producto = mysqli_fetch_array($resultProducto)) {
                        ...
                        if ($periodoInd == "1") {
                            ...
                            $consultaProduct = "SELECT COUNT(producto) FROM folios_g WHERE producto = '$datosProducto' AND t_solicitud = 'ALTA POLIZA INTERNACIONAL' AND MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year' AND agente = '$id_agente'";
                        } else {
                ...
                ?>[
                    ...
                    while ($producto = mysqli_fetch_array($resultProducto)) {
                        ...
                        if ($periodoInd == "1") {
                            ...
                            $consultaProduct = "SELECT COUNT(producto) FROM folios_g WHERE producto = '$datosProducto' AND t_solicitud = 'MOVIMIENTOS' AND MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year' AND agente = '$id_agente'";
                        } else {

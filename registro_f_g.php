    ...
    <div class="col-sm-12">
        ...
        <table data-order='[[0, "desc"]]' class="table table-hover table-condensed table-bordered" id="tablaDinamicaLoadGmm">
            ...
            <tbody>
                <?php
                if (empty($poliza)) {
                    $nomagente = "SELECT id FROM datos_agente WHERE nombre like '%$asegurado%'";
                    $resultnom = mysqli_query($conexion, $nomagente);
                    while ($vernom = mysqli_fetch_row($resultnom)) {
                        $dnom = $vernom[0];

                        //echo $dnom;
                        $sql = "SELECT * FROM folios_g WHERE agente = '$dnom'";
                ...
                ?>
                            <tr>
                                ...
                                <td align="center" width="50px">
                                    <form class="" action="seguimiento_g_c.php?id=<?php echo $ver[0]; ?>" method="post">
                    ...
                    while ($vernom = mysqli_fetch_row($resultnom)) {
                        ...
                        $sql = "SELECT * FROM folios_g WHERE id LIKE '%$poliza%' and agente = '$dnom'";
                        $result = mysqli_query($conexion, $sql);
                        while ($ver = mysqli_fetch_row($result)) {
                            $datos = $ver[0] . "||" .
                                $ver[1] . "||" .
                        ...
                        ?>
                            <tr>
                                ...
                                <td align="center" width="30px" style="vertical-align: middle;">
                                    <span style="font-weight:bold;"><small><?php echo $ver[0]; ?></small></span>
                                </td>

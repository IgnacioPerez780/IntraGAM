...
if (isset($_SESSION['logged_in'])) {
    ...
    if (isset($_SESSION["timeout"])) {
        ...
        if ($sessionTTL > $inactive) {
            ...
            if ($nomusuario == "Veronica S" || $nomusuario == "Giovanni M" || $nomusuario == "Karla B" || $nomusuario == "Diana C" || $nomusuario == "Carolina H" || $nomusuario == "Dante V" || $nomusuario == "Manuel R" || $nomusuario == "Roberto R" || $nomusuario == "Omar S" || $nomusuario == "Martin G" || $nomusuario == "Nancy O") {
...
if ($_SESSION['rol'] == '1') {
    ...
    include('plantillas/cabecera_promocion_a.php');
}
?>
                ...
                <tbody>
                    <tr>
                        <td colspan="8" align="center" class="seguimiento">
                            <b>
                                <h2>
                                    <p>Seguimiento de <?php echo $nomusuario; ?></p>
                                </h2>
                            </b>
                        </td>
                    </tr>
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    "> <!-- SE CIERRA LA ETIQUETA A CON EL TOOLTIP -->
                        ...
                        <tr class="observaciones">
                            ...
                            <td colspan="1" align="center" class="observaciones">
                        ...
                        <tr class="observaciones">
                            ...
                            <td colspan="2" align="center" class="observaciones"><b>Asignar folio GNP:</b></td>
                            <td colspan="2" align="center" class="observaciones"><input type="text" value="<?php echo $ver[8]; ?>" id="fgnp" name="fgnp"></td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center" class="observaciones"><b></b></td>
                            <td colspan="2" align="center" class="observaciones">
                            </td>

                            <td colspan="2" align="center" class="observaciones"><b>Asignar póliza GNP:</b></td>
                            <td colspan="2" align="center" class="observaciones"><input type="text" value="<?php echo  $ver[7]; ?>" id="poliza" name="poliza"></td>
                        </tr>
                        <tr>
                    ...
                    <?php if ($ver[13] == 'TERMINADO') { ?>
                        ...
                        <form enctype="multipart/form-data" id="filesforma">
                            <tr>
                                <td colspan="9" align="center" bgcolor="#428BCA" class="agregar">
                                    <b>
                                        <p style="color: #FFFFFF">AGREGAR MAS ARCHIVOS</p>
                                    </b>
                                </td>
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    <tr class="observaciones">
                        ...
                        <td colspan="2" align="center"><input type="text" value="<?php echo $ver[8]; ?>" id="fgnp" name="fgnp"></td>
                    </tr>
                    <tr class="observaciones">
                        ...
                        <td colspan="2" align="center"><input type="text" value="<?php echo  $ver[7]; ?>" id="poliza" name="poliza"></td>
                    </tr>
                    <tr class="observaciones">
                        <td colspan="8" align="center">
                            <button type="button" class="btn btn-warning glyphicon glyphicon-ok" id="guardar5"></button>
        ...
        $('#guardar5').click(function() {
            ...
            if (estado == 'PROCESO') {
                if (comentario.length == 0) {
                    swal({
                        title: "¡Error!",
                        text: "Ingresa un comentario justificando el cambio",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });
            ...
            if (estado == 'TERMINADO') {
                if (comentario.length == 0) {
                    ...
                    swal({
                        title: "¡Error!",
                        text: "Asigna el Folio GNP correspondiente",
                        type: "error",
                        customClass: 'swal-wide',
                        allowOutsideClick: false
                    });

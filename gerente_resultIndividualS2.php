...
<script type="text/javascript">
    ...
    Highcharts.chart('containerVIDA2', {
        ...
        title: {
            text: 'PRODUCTOS VIDA <?php if ($periodoInd == "1") {
                                        echo "MES " . $meses . " AÑO " . $añoInd;
                                    }
                                    if ($periodoInd == "7") {
    ...
    Highcharts.chart('containerGMM2', {
        ...
        title: {
            text: 'PRODUCTOS GMM <?php if ($periodoInd == "1") {
                                        echo "MES " . $meses . " AÑO " . $añoInd;
                                    }
                                    if ($periodoInd == "7") {
                                        echo "DESDE " . $periodoSemInd1 . " HASTA " . $periodoSemInd2;
                                    }
                                    if ($periodoInd == "4") {
                                        echo "CUATRIMESTRE " . $periodoCuatrimestralInd . " AÑO " . $añoInd;
                                    }
    ...
    Highcharts.chart('containerAUTOS2', {
        ...
        title: {
            text: 'PRODUCTOS AUTOS <?php if ($periodoInd == "1") {
                                        echo "MES " . $meses . " AÑO " . $añoInd;
                                    }
                                    if ($periodoInd == "7") {
                                        echo "DESDE " . $periodoSemInd1 . " HASTA " . $periodoSemInd2;
                ...
                ?>[
                    ...
                    while ($tipo_sol = mysqli_fetch_array($resultProducto)) {
                        ...
                        if ($periodoInd == "1") {
                            ...
                            $consultaProduct = "SELECT COUNT(tipo_sol) FROM folios_s WHERE tipo_sol = '$datosProducto' AND linea_s = 'AUTOS' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'  AND id_agente = '$id_agente'";
                        } else {
    ...
    Highcharts.chart('containerDAÑOS2', {
        ...
        title: {
            text: 'PRODUCTOS DAÑOS <?php if ($periodoInd == "1") {
                                        echo "MES " . $meses . " AÑO " . $añoInd;
                                    }
                                    if ($periodoInd == "7") {
                                        echo "DESDE " . $periodoSemInd1 . " HASTA " . $periodoSemInd2;
                ...
                ?>[
                    ...
                    while ($tipo_sol = mysqli_fetch_array($resultProducto)) {
                        ...
                        if ($periodoInd == "1") {
                            ...
                            $consultaProduct = "SELECT COUNT(tipo_sol) FROM folios_s WHERE tipo_sol = '$datosProducto' AND linea_s = 'DAÑOS' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'  AND id_agente = '$id_agente'";
                        } else {

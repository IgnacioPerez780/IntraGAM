...
<table class="table table-hove table-condensed table-bordered text-center" id="tabla_primaAcomuladaGmm">
    ...
    <tr>
        ...
        <td style="width: 210px;background-color:#555859;color:#FFFFFF;">
            <small>
                <label class="labelP">NACIONAL</label>
            </small>
        </td>
        <td style="width: 210px;background-color:#555859;color:#FFFFFF;">
            <small>
                <label class="labelD">INTERNACIONAL</label>
            </small>
        </td>
    </tr>
    ...
    <tr style="background-color:#FFFFFF;">
        ...
        <td>
            <small>
                ...
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT FORMAT(SUM(REPLACE(prima,',', '')),2) AS prima FROM folios_g WHERE t_solicitud = 'ALTA POLIZA NACIONAL' AND (NOT estado = 'CANCELADO') AND moneda_apn = 'PESOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
        ...
        <td>
            <small>
                ...
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT FORMAT(SUM(REPLACE(prima,',', '')),2) AS prima FROM folios_g WHERE t_solicitud = 'ALTA POLIZA INTERNACIONAL' AND moneda_api = 'PESOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                    $resultEstadoIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                ?>
                        <label class="gmDolares">$<?= $datoEstadoIndSem . '<br>'; ?></label>
                    <?php
                    }
                    // MENSUAL
                } elseif ($periodoIndividual == "mensualInd") {
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td class="estatus">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT DISTINCT(estado) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA NACIONAL' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' ORDER BY estado";
                    $resultEstadoIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                        echo $datoEstadoIndSem . '<br>';
                    }
                } elseif ($periodoIndividual == "mensualInd") {
                    $dayIndM = "01";
                    $yearIndM = $_POST['yearIndividual'];
        ...
        <td class="nFolio">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA NACIONAL' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' GROUP BY estado ORDER BY estado";
                    $resultEstadoIndIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                        echo $datoEstadoIndSem . '<br>';
                    }
                } elseif ($periodoIndividual == "mensualInd") {
        ...
        <td class="tFolios">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA NACIONAL' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                    $resultEstadoIndIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                ?>
                        <label class="totalFolios"><?= $datoEstadoIndSem . '<br>'; ?></label>
                    <?php
                    }
                } elseif ($periodoIndividual == "mensualInd") {
                    $dayIndM = "01";
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td class="estatus">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT DISTINCT(estado) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA INTERNACIONAL' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' ORDER BY estado";
                    $resultEstadoIndIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                        echo $datoEstadoIndSem . '<br>';
        ...
        <td class="nFolio">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA INTERNACIONAL' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' GROUP BY estado ORDER BY estado";
                    $resultEstadoIndIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                        echo $datoEstadoIndSem . '<br>';
        ...
        <td class="tFolios">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA INTERNACIONAL' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                    $resultEstadoIndIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                ?>
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td class="estatus">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT DISTINCT(estado) FROM folios_g WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' ORDER BY estado";
                    $resultEstadoIndIndSem  = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem  = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem  = $verEstadoIndSem[0];
                        echo $datoEstadoIndSem  . '<br>';
        ...
        <td class="nFolio">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente' GROUP BY estado ORDER BY estado";
                    $resultEstadoIndIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                        echo $datoEstadoIndSem . '<br>';
        ...
        <td class="tFolios">
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'MOVIMIENTOS' AND DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                    $resultEstadoIndIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                ?>
    ...
    <tr style="background: #FFFFFF;">
        ...
        <td>
            <small>
                <?php
                if ($periodoIndividual == "semanalInd") {
                    $sqlEstadoIndSem = "SELECT COUNT(*) FROM folios_g WHERE DATE(fecha) BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                    $resultEstadoIndIndSem = mysqli_query($conexion, $sqlEstadoIndSem);
                    while ($verEstadoIndSem = mysqli_fetch_array($resultEstadoIndIndSem)) {
                        $datoEstadoIndSem = $verEstadoIndSem[0];
                ?>
                    ...
                    $sqlEstadoM = "SELECT COUNT(*) FROM folios_g WHERE MONTH(fecha) = '$monthIndM' AND YEAR(fecha) = '$yearIndM' AND agente = '$id_agente'";
                    $resultEstadoM = mysqli_query($conexion, $sqlEstadoM);
                    while ($verEstadoM = mysqli_fetch_array($resultEstadoM)) {
                        $datoEstadoM = $verEstadoM[0];
                    ?>
                    ...
                    if ($monthIndividualC == "primerCind") {
                        ...
                        $sqlEstadoC = "SELECT COUNT(*) FROM folios_g WHERE fecha BETWEEN '$fecha1Cind' AND '$resultFechaCind' AND agente = '$id_agente'";
                        $resultEstadoC = mysqli_query($conexion, $sqlEstadoC);
                        while ($verEstadoC = mysqli_fetch_array($resultEstadoC)) {
                            $datoEstadoC = $verEstadoC[0];
                        ?>
                    ...
                    if ($monthIndividualS == "primerSind") {
                        ...
                        $sqlEstadoS = "SELECT COUNT(*) FROM folios_g WHERE fecha BETWEEN '$fechaIndividualS1' AND '$resultFechaSind' AND agente = '$id_agente'";
                        $resultEstadoS = mysqli_query($conexion, $sqlEstadoS);
                        while ($verEstadoS = mysqli_fetch_array($resultEstadoS)) {
                            $datoEstadoS = $verEstadoS[0];
                        ?>
                    ...
                    $sqlEstadoS = "SELECT COUNT(*) FROM folios_g WHERE fecha BETWEEN '$fechaIndividualY1' AND '$resultFechaY' AND agente = '$id_agente'";
                    $resultEstadoS = mysqli_query($conexion, $sqlEstadoS);
                    while ($verEstadoS = mysqli_fetch_array($resultEstadoS)) {
                        $datoEstadoS = $verEstadoS[0];
                        ?>
...
<?php
if ($datoEstadoIndSem == 0 && $datoEstadoM == 0 && $datoEstadoC == 0 && $datoEstadoS == 0 && $datoEstadoY == 0) {

...
<div id="containerAInd1"></div>
<script type="text/javascript">
    // GRAFICA PARA MOSTRAR EL TOTAL DE TRAMITES
    Highcharts.chart('containerAInd1', {
        chart: {
        ...
        subtitle: {
            text: 'Total: <?php
                            ...
                            if ($periodoInd == "7") {
                                $consultSem = "SELECT COUNT(*) FROM folios_a WHERE fecha BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                            ...
                            if ($periodoInd == "4") {
                                ...
                                if ($mes == "1") {
                                    ...
                                    $consultaAgente = "SELECT COUNT(*) FROM folios_a WHERE fecha BETWEEN '$fecha1' AND '$fecha2' AND agente = '$id_agente'";
                                    $resultAgente = mysqli_query($conexion, $consultaAgente);
                                    while ($agente = mysqli_fetch_array($resultAgente)) {
                                        $datosAgente = $agente[0];
        ...
        series: [
            ...
            if ($periodoInd == "1") {
                ...
                $consultaProspectos = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'NUEVO NEGOCIO' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'  AND agente = '$id_agente'";
                ...
                $consultaProspectos = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'NUEVO NEGOCIO' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'  AND agente = '$id_agente'";
                $resultProspectos = mysqli_query($conexion, $consultaProspectos);
                $prospectos = mysqli_fetch_array($resultProspectos);
                $datosProspectos = $prospectos[0];
            }
            ...
            if ($periodoInd == "1") {
                ...
                $date = new DateTime($year . '-' . $month . '-' . $day);
                $fecha = $date->format('Y-m-d');
                $consultaCitas = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'MOVIMIENTOS' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'  AND agente = '$id_agente'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            } else {
                $consultaCitas = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'MOVIMIENTOS' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'  AND agente = '$id_agente'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            }

            // MUESTRA LAS BARRAS DE LA GRAFICA DEL LADO DERECHO
            if ($periodoInd == "7") {
                $consultaProspectos = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'NUEVO NEGOCIO' AND fecha BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                $resultProspectos = mysqli_query($conexion, $consultaProspectos);
                $prospectos = mysqli_fetch_array($resultProspectos);
                $datosProspectos = $prospectos[0];
            }
            ...
            if ($periodoInd == "7") {
                $consultaCitas = "SELECT COUNT(*) FROM folios_a WHERE t_solicitud = 'MOVIMIENTOS' AND fecha BETWEEN '$periodoSemInd1' AND '$periodoSemInd2' AND agente = '$id_agente'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            }
        ...
        drilldown: {
            ...
            series: [{
                    ...
                    data: [
                        ...
                        $consultaFecha = "SELECT  COUNT(DISTINCT producto) FROM folios_a WHERE t_solicitud = 'NUEVO NEGOCIO' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'  AND agente = '$id_agente'";

...
//var_dump($ids);
$cont = "UPDATE notificaciones1_s set contador='0' where folio='$ids'";
...
<!-- termina codigo alertas
 -->
    ...
    <link rel="stylesheet" type="text/css" href="css/main_siniestros.css">
    <!-- JS - BARRA DE PROGRESO-->
    <script src="js/main_siniestros_agente.js"></script>
...
<body <?php if (in_array($ids, $categorias2)) { //CONFORMIDAD
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
                    ...
                    <input style="display: none;" type="radio" name="ramo" value="SINIESTROS" checked>

                    <input style="display: none;" type="radio" name="folio" value="<?php echo $ids;  ?>" checked>

        

                   <div class="feedback" id="pregunta2">
                   <h4 style="text-align:center;"> <p> 1.- ¿Qué tan conforme estas con la resolución de tu solicitud? </p></h4>
...
<div id="pregunta3" style="display:none;" class="form-check-input" align="center" style="text-align: center;">
    <h4> <p> 2.- ¿El consultor solicitó toda la documentación necesaria para la gestión de tu solicitud desde el inicio?  </p> </h4>  
                      <br>
    <label class="btn ">
    ...
    <label class="btn ">
        ...
        <div id="pregunta4" style="display:none;" class="form-check-input" align="center" style="text-align: center;">
                      <h4> <p> 3.- ¿Algún comentario adicional?   </p> </h4>  
                      <br>
          ...
          <!-- pie del diálogo -->
                      ...
                      <div class="modal-footer" id="pie2">
    ...
    <div class="container">
        <div class="col-sm-12">
                    ...
                    ?>
                        ...
                        <?php if ($ver[14] == "CANCELADO") { ?>
                            ...
                            <tr align="center" class="datosDocument">
                                ...
                                <td colspan="2"><b>Fecha de carga</td>
                            </tr>
                            <?php
                            $query1 = "SELECT id, nombre, fecha_creacion, fk_folio, nomusuario FROM archivos_s WHERE fk_folio = '$ids' order by id desc";
                            $resultado = mysqli_query($conexion, $query1);
                            while ($row = mysqli_fetch_array($resultado)) {
                            ?>
                                <tr>
                                    <td colspan="1" align="center"><?php echo $row[4]; ?></td> <!-- NOMBRE DEL USUARIO -->
                                    <td colspan="2" align="center"><?php echo $row[1]; ?></td> <!-- NOMBRE DEL ARCHIVO -->
                                    <td colspan="1" align="center" <?php  if ($respondido != $ids && $terminado == '1' ) { ?> onclick="return abrirmodal();" <?php } ?>> <a href="../sistemas/archivos_s/<?php echo $row[1]; ?>" target=" _blank">
                                            <!-- VER ARCHIVO -->
                            ...
                            <form action="anexar1_s.php" method="POST" enctype="multipart/form-data">
         ...
         <a  style="color: black"
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    "> <!-- SE CIERRA LA ETIQUETA A CON EL TOOLTIP -->
                        ...
                        <tr class="observaciones">
                            ...
                            <td align="center">
                                <button type="button" class="btn btn-warning glyphicon glyphicon-ok" id="guardar1" disabled></button>
                            </td>
                        </tr>


                        <!--CIERRE DEL CANCELADO-->
                    <?php } ?>
                    ...
                    <?php if ($ver[14] == "ENVIADO" || $ver[14] == "INCOMPLETO" || $ver[14] == "PROCESO" || $ver[14] == "PROCESO GNP" || $ver[14] == "REPROCESO") { ?>
                        ...
                        <?php if ($ver[2] == 'GMM') { ?>
                            ...
                            <tr>
                                <td colspan="2" align="center"><b>Descripción Detallada:</b></td>
                                <td colspan="6" align="center"><?php echo $ver[13]; ?></td>
                            </tr>
                            <tr>
                                <td colspan="8" align="center" bgcolor="#eeefef"><b></b></td>
                        ...
                        <!-- ARCHIVOS (BARRA DE PROGRESO EN TODOS LOS ESTADOS - MENOS EN TERMINADO Y CANCELADO) -->

                        <form action="" id="form_subir" enctype="multipart/form-data">
                            <input type="text" hidden="" id="nomusuario" name="nomusuario" value="<?php echo "$nomusuario"; ?>">
                            <input type="text" hidden="" id="idf" name="idf" value="<?php echo "$ids"; ?>">
                            <tr>
                            ...
                            <tr>
                                <td colspan="9" align="center">
                                    <div class="form-1-2">
                                        <input id="agregar2" type="file" name="file" accept=".pdf"> <!-- AGREGAR ARCHIVO -->
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="9" align="center">
                                    <div class="acciones">
                                        <button type="submit" onclick="return subir2();" class="btn btn-primary" id="subir">Subir Archivo</button> <!-- BOTON PARA SUBIR ARCHIVO -->
              ...
              data-title="  <?php  $mod = "SELECT * FROM datos_operativos WHERE nomusuario = '$ver1[4]' ";
                ...
                <div style='background:#F2F2F2;line-height:30px;-webkit-border-radius: 3px; -moz-border-radius: 3px; border-radius: 3px;text-align:left;padding-left:15px;'>
                    ...
                    <tr class="observaciones">
                        ...
                        <td align="center">
                            <button type="button" class="btn btn-warning glyphicon glyphicon-ok" id="guardar1"></button>
                        </td>
                    </tr>
                ...
                <?php if ($ver[14] == 'TERMINADO') { ?>
                    ...
                    <!-- ARCHIVOS (BARRA DE PROGRESO EN EL ESTADO TERMINADO)-->
                <tbody>
                    <form action="" id="form_subir" enctype="multipart/form-data">
                        <input type="text" hidden="" id="nomusuario" name="nomusuario" value="<?php echo "$nomusuario"; ?>">
                        <input type="text" hidden="" id="idf" name="idf" value="<?php echo "$ids"; ?>">
            ...
            <tr class="observaciones">
                <td colspan="2" align="center" style="width:30px;text-align:justify"><small><b>De acuerdo a la Circular 16 de GNP donde se solicita la documentación física en original sin tachaduras ni enmendaduras,
                ...
                <td colspan="5" align="center">
                    ...
                    <form action="validar-checkbox_s.php" method="POST">
                        <div class="checkbox" id="checkbox_s" align="center">
                            <input type="checkbox" style="display: none" id="checkbox1_s" name="condiciones[<?php echo $ids; ?>]" value="<?php echo "$ids"; ?>" onclick="validarcheck_s()">
                            <label style="font-weight:bold;color:#FFFFFF" for="checkbox1_s">Acepto términos y condiciones bajo los que fue resuelta mi solicitud.</label required>
                            <br><button type="submit" class="btn btn-warning glyphicon glyphicon-ok" id="aceptar_s" style="display: none"></button></br>
                        </div>
                    </form>
    ...
    function enviar() {
     ...
     $('[rel="tooltip"]').tooltip();
        ...
        function conformidad_s() {
            ...
            document.getElementById("checkbox1_s").disabled = true;
            document.getElementById("aceptar_s").style.display = 'none';
            document.getElementById("agregar2").disabled = true;
            document.getElementById("checkbox1_s").checked = true;
        }

        function validarcheck_s() {
            var opcion = document.getElementById('checkbox1_s');
            if (opcion.checked == true) { //botón seleccionado
                document.getElementById("aceptar_s").style.display = 'block';
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#guardar1').click(function() {
                ...
                //CONDICIÓN PARA INGRESAR UN COMENTARIO
                var estado = document.getElementById('estadoss').value;
                var comentario = document.getElementById('observaciones').value;
                if (estado == 'ENVIADO' || estado == 'INCOMPLETO' || estado == 'PROCESO' || estado == 'PROCESO GNP' || estado == 'REPROCESO' || estado == 'TERMINADO') {

...
$consulta = "INSERT INTO carpetas_digitalizacion_pymes (nombreContratante, agente, numeroP, vigencia, primaNeta,formaPago, moneda, ramo, comentario, fecha, usuario ) VALUES ('$nombreContratante', '$agente','$numeroP', '$vigencia','$primaNeta','$formaPago', '$moneda','$ramo', '$comentario', '$fecha', '$nomusuario')";
...
<form name="miformulario" action="resp_digitales.php" method="POST">

...
echo "Resultados de la b&uacute;squeda entre las fechas <b>" . $fec1 . "</b> / <b>" . $fec2 . "</b> del Consultor <b>DIANA CASTRO GARCIA</b><br>";
...
<table class="table table-hove table-condensed text-center" id="sesionI_di">
    <thead>

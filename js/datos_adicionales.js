    ...
    if (ramo == "gmm") {
        if (periodoGen == "semanal") {
            if (periodoSemG1 > periodoSemG2) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'datoA_gmm_resultGeneral.php',
                    data: datosGenerales,
...
function showIndividual() {
    ...
    if (periodo == "semanalInd") {
        ...
        document.getElementById('semanalInd').style.display =
            document.getElementById('mensualInd').style.display = "none";
    ...
    if (ramo == "gmm") {
        if (periodoInd == "semanalInd") {
            if (periodoSemInd1 > periodoSemInd2) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'datoA_gmm_resultIndividual.php',
        ...
        if (periodoInd == "semanalInd") {
            if (periodoSemInd1 > periodoSemInd2) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'datoA_s_resultIndividual.php',
                    data: datosIndividuales,
                    success: function (resp) {
                        $('#resp_Ind').html(resp);
                    }
        ...
        if (periodoInd == "semanalInd") {
            if (periodoSemInd1 > periodoSemInd2) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'datoA_a_resultIndividual.php',
                    data: datosIndividuales,
                    success: function (resp) {
                        $('#resp_Ind').html(resp);
                    }
    ...
    if (ramo == "vida") {
        if (periodoInd == "semanalIndV") {
            if (periodoSemInd1 > periodoSemInd2) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'datoA_v_resultIndividual.php',
                    data: datosIndividuales,
                    success: function (resp) {

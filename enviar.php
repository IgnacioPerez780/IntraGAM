...
$ruta = "material_camp/".$v1;

$consulta = "INSERT INTO material_camp (urlArchivo) VALUES ('".$ruta."')";

$resultado = mysqli_query( $conexion, $consulta ) or die ( "Algo ha ido mal en la consulta a la base de datos");

mysqli_close( $conexion );

$ruta_carpeta = "material_camp/"; //ruta para guardar los archivos en el servidor

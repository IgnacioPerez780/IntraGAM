...
<body>
    ...
    <div class="container">
        <?php include('componentes/tabla_a_con.php'); ?>
        <div id="tabla"></div>
    </div>
            ...
            <div class="modal-content">
                    ...
                    function validar() {
                        ...
                        if (agente.length == 0) {
                            ...
                            if (num_resolucion.length == 0) {
                                ...
                                swal({
                                    title: "¡Error!",
                                    text: "Seleccione una opción del combo Producto",
                                    type: "error",
                                    customClass: 'swal-wide',
                                    allowOutsideClick: false
                                });
                                ...
                                if (motivo.length == 0) {
                                    ...
                                    if (descripcion.length == 0) {
                                        ...
                                        swal({
                                            ...
                                            function() {
                                                $$guarda = (guardarfolioautos() + actualizar());
                                            });
                                    }
                                } else if (telefono.length == 0) {
                                    swal({
                ...
                <script>
                    function guardarfolioautos() {
                        ...
                        $.ajax({
                            url: 'php/agregarfolio_autos_consultor.php',
                            type: 'POST',
                            contentType: false,
                            data: formdata,
                            processData: false,

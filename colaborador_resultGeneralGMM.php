    ...
    Highcharts.chart('container7', {
        ...
        subtitle: {
            text: 'Total:  <?php
                            ...
                            if ($periodoGeneral == "7") {
                                $consultaSem = "SELECT COUNT(*) FROM folios_g WHERE fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
        ...
        series: [
            ...
            if ($periodoGeneral == "1") {
                ...
                $consultaProspectos = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA NACIONAL' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                ...
                $consultaProspectos = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA NACIONAL' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultProspectos = mysqli_query($conexion, $consultaProspectos);
                $prospectos = mysqli_fetch_array($resultProspectos);
                $datosProspectos = $prospectos[0];
            }
            ...
            if ($periodoGeneral == "1") {
                ...
                $date = new DateTime($year . '-' . $month . '-' . $day);
                $fecha = $date->format('Y-m-d');
                $consultaCitas = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA INTERNACIONAL' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            } else {
                $consultaCitas = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA INTERNACIONAL' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            }
            ...
            if ($periodoGeneral == "1") {
                ...
                $date = new DateTime($year . '-' . $month . '-' . $day);
                $fecha = $date->format('Y-m-d');
                $consultaEntrevista = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'MOVIMIENTOS' AND  MONTH(fecha)  = '$month' AND YEAR(fecha) = '$year'";
                ...
                $consultaEntrevista = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'MOVIMIENTOS' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
                $resultEntrevista = mysqli_query($conexion, $consultaEntrevista);
                $entrevista = mysqli_fetch_array($resultEntrevista);
                $datosEntrevista = $entrevista[0];
            }
            ...
            if ($periodoGeneral == "7") {
                $consultaProspectos = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA NACIONAL' AND fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
                $resultProspectos = mysqli_query($conexion, $consultaProspectos);
                $prospectos = mysqli_fetch_array($resultProspectos);
                $datosProspectos = $prospectos[0];
            }
            ...
            if ($periodoGeneral == "7") {
                $consultaCitas = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'ALTA POLIZA INTERNACIONAL' AND fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
                $resultCitas = mysqli_query($conexion, $consultaCitas);
                $citas = mysqli_fetch_array($resultCitas);
                $datosCitas = $citas[0];
            }
            ...
            if ($periodoGeneral == "7") {
                $consultaEntrevista = "SELECT COUNT(*) FROM folios_g WHERE t_solicitud = 'MOVIMIENTOS' AND fecha BETWEEN '$periodoSemG1' AND '$periodoSemG2'";
                $resultEntrevista = mysqli_query($conexion, $consultaEntrevista);
                $entrevista = mysqli_fetch_array($resultEntrevista);
                $datosEntrevista = $entrevista[0];
            }
        ...
        drilldown: {
            ...
            series: [{
                    ...
                    data: [
                        ...
                        $consultaFecha = "SELECT producto FROM folios_g WHERE t_solicitud = 'ALTA POLIZA NACIONAL' AND fecha BETWEEN '$fecha1' AND '$nuevafecha2'";
